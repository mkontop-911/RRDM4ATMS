...
:ATMs_WCR01
sc create "RRDM RFM %OrigATMs%" binpath= "C:\RRDM\RRDMExec\RRDMRFMService.exe %OrigATMs% %ATMs% ETHNCY2N"
...
:T24_T2401
sc create "RRDM RFM %OrigT24%" binpath= "C:\RRDM\RRDMExec\RRDMRFMService.exe %OrigT24% %T24% ETHNCY2N"
...
:Base24_FTOD-TLF
sc create "RRDM RFM %OrigBase24%" binpath= "C:\RRDM\RRDMExec\RRDMRFMService.exe %OrigBase24% %Base24% ETHNCY2N"
