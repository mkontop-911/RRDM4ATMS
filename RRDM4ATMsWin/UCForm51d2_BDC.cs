...
{
    public partial class UCForm51d2_BDC : UserControl
    {
        //
        ...
        public void UCForm51d2Par_BDC(string InSignedId, int InSignRecordNo, string InOperator, string InAtmNo, int InSesNo)
        {
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (CashInAmount == 0 & Ra.NewAmount == 0)
            {
                ...
                {
                    MessageBox.Show("No Money to Update!" + Environment.NewLine
                                    + "Input value is zero" + Environment.NewLine
