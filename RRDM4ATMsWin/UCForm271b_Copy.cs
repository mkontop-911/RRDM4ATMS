...
{
    public partial class UCForm271b_Copy : UserControl
    {
        ...
        public void UCForm271bPar_Copy(string InSignedId, int SignRecordNo, string InOperator, string InRMCategoryId, int InRMCycle, int InActionOrigin
                                                                    , string InAtmNo, int InSesNo)
        {
            ...
            //if (WActionOrigin == 1)
            //{
            //    // labelActionType.Text = "Action At Recomciliation";
            //    // labelActionType.Text = "Action At Recomciliation";
            //};

            //if (WActionOrigin == 2)
            //{
            //  //  labelActionType.Text = "Action At Replenishement";
            //};
        ...
        private void buttonAction_Click(object sender, EventArgs e)
        {
                ...
                & WActionId != "06" & WActionId != "08" & WActionId != "09" & Is_POS == false & ValidAction == true)
            {
                ...
                if (WActionTxnAmt > CurrentExcess & WOriginWorkFlow == "Replenishment" & Mpa.MetaExceptionId == 55)
                {
        ...
        private void buttonAllActions_Click(object sender, EventArgs e)
        {
            ...
            if (WActionOrigin == 1)
            {
                WSelectionCriteria = "WHERE RMCateg='" + WRMCategoryId + "' AND MatchingAtRMCycle =" + WRMCycleNo + " AND (OriginWorkFlow ='Reconciliation' OR OriginWorkFlow ='Dispute') "; ;
            }
            if (WActionOrigin == 2)
            {
