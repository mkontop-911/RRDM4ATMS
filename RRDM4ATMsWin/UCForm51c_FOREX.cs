...
{
    public partial class UCForm51c_FOREX : UserControl
    {
        // Working variables
        ...
        public DataTable DataTable_FOREX_TOTALS = new DataTable();
        ...
        public void UCForm51cPar_FOREX(string InSignedId, int InSignRecordNo, string InOperator, string InAtmNo, int InSesNo, bool IsFromExcel)
        {
           ...
           // string WSelection= " WHERE AtmNo ='"+ WAtmNo +"' And ReplCycle =" + WSesNo; 
           // Ce.Read_CIT_Excel_Table_BySelectionCriteria(WSelection);

           //// WSelection = " WHERE SeqNo=" + Ce.BulkRecordId; 
           // Ce.UPDATE_FOREX_IN_SM(WAtmNo, WSesNo, Ce.BulkRecordId); 

            // BASED ON FOREX LOADED DATA - not of Journal 
            ...
            int WWMode = 15;
            Mgt.ReadTrans_TXNS_FromSpecificTableBetween_Dates_Short(WSignedId, WTableId, WAtmNo, Ta.SesDtTimeStart, Ta.SesDtTimeEnd, WWMode, 2);

            int rows = Mgt.DataTableAllFields.Rows.Count;

            DataTable_FOREX_TOTALS = Mgt.DataTableAllFields; 
            ...
            else
            {
               ...
               int WTotalNotes;
                ...
                while (I <= (DataTable_FOREX_TOTALS.Rows.Count - 1))
                {
                    // "  SELECT Currency As Ccy, SUM(Cassette) as TotalNotes, sum(Facevalue * CASSETTE) as TotalMoney "

                    string WCcy = (string)DataTable_FOREX_TOTALS.Rows[I]["Ccy"];
                    WCcy = WCcy.Trim(); 
                    if (WCcy == "")
                    {
                        I = I + 1;
                    ...
                    WTotalNotes = (int)DataTable_FOREX_TOTALS.Rows[I]["NumberOfTxns"];
                    WTotalMoneyDecimal = (decimal)DataTable_FOREX_TOTALS.Rows[I]["TotalAmt"];

                    //WRetractTotalNotes = 0 ;
                    //WRetractTotalMoney = 0;
                    ...
                    //WRECYCLEDTotalNotes = 0;
                    //WRECYCLEDTotalMoney = 0;
            ...
            //     //L = 1; // leave it 1
            //     //I = 0;
            //    // THE BELOW COMMENTED OUT IS USED WHEN THERE ARE EGP DEPOSITS
            //    // NOW WITH NEW METHOD WE ARE BASED ON IST AND ONLY FOREX
            ...
            //
            FMode = 1; // only 
            Er.ReadAllErrorsTableToFindTotalsForSuspectAndFake(WAtmNo, WSesNo, 0, FMode);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // CREATE ACTIONS FOR FOREX
                CreateActions_Occurances_FOR_FOREX();
        ...
        public void CreateActions_Occurances_FOR_FOREX()
        {
            // Create 
