...
{
    public partial class Form56R33ITMX : Form
    {
        string WR1;
        string WR2;
        string WR3;
        ...
        public Form56R33ITMX(string R1, string R2, string R3, string R4, string R5, string R6)
        {
            WR1 = R1;
            WR2 = R2;
            WR3 = R3;
        ...
        private void Form56R33ITMX_Load(object sender, EventArgs e)
        {
            //ShowReport();
            ...
            try
            {
                ...
                string RSReportName = RsDir + "/ITMXSettlement33";
        ...
        private ArrayList ReportDefaultPatam()
        {
            ...
            arrLstDefaultParam.Add(CreateReportParameter("SettlementCycle", WR1));
            arrLstDefaultParam.Add(CreateReportParameter("SettlementDate", WR2));
            arrLstDefaultParam.Add(CreateReportParameter("Bank", WR3));
            arrLstDefaultParam.Add(CreateReportParameter("OtherBank", WR4));
            arrLstDefaultParam.Add(CreateReportParameter("InBankIdLogo", WR5));
            arrLstDefaultParam.Add(CreateReportParameter("InUserId", WR6));
