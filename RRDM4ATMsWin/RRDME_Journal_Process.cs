...
namespace RRDM4ATMsWin
{
    ...
    //    E_JournalTxtClass Ejc = new E_JournalTxtClass(); 
        ...
        RRDMErrorsMatchingClass Em = new RRDMErrorsMatchingClass();
    ...
    //        Int32 LastDigit;
       //     int SmTrace; 
            ...
            if (KontoReady == true & WAtmNo == "AB104" & WSignedId == "501") // DO THIS FOR TESTING USER 
            {
                ...
                string WIpAddress = Ac.IpAddress;
            ...
            string SqlString2 = "SELECT atmno, TraceNumber, ISNULL(fuid, 0) AS fuid, ISNULL(trandesc, '') AS trandesc,"
     ...
     // READ Errors 
            ...
            Ec.ReadAllErrorsTableForCounters(WOperator, WAtmNo);
        ...
        private void StoreProcKontoEJournal(string InBankId, string InAtmNo, string InJournalType, string InPathName)
        {
            ...
            using (SqlConnection conn =
                ...
                try
                {
                   ...
                   //     cmd.Parameters.AddWithValue("@JournalType", InJournalType);
