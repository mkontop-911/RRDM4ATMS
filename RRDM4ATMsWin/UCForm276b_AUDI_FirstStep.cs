...
{
    public partial class UCForm276b_AUDI_FirstStep : UserControl
    {
        ...
        public void UCForm276b_AUDI_FirstStep_Par(string InSignedId, int SignRecordNo, string InOperator,
        ...
        public void SetScreen()
        {
            ...
            //                              // 4: Valid At Maker (Ready for transactions creation) 
            //                              // 4: If CIT equals to SM + presenter then this valid
            //                              // 6: Invalid At Maker - Not Ready for transactions creation
            ...
            {
                SelectionCriteria = " WHERE CITId = '" + WCitId + "' AND ProcessMode_UnLoad = 2  AND LoadingExcelCycleNo=" + WLoadingExcelCycle;

            }
            else
            {
                SelectionCriteria = " WHERE CITId = '" + WCitId + "' AND Repl_UnLoad_Status in ( 4, 6 ) AND ProcessMode_UnLoad <> 2 ";
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            decimal CIT_Unloaded = G4.UnloadedCounted + G4.Deposits;
            decimal SM_Unloaded = G4.SM_Unloaded_Cassette + G4.SM_Unloaded_Deposits + G4.PresentedErrors; 

            textBoxCITAmount.Text = CIT_Unloaded.ToString("#,##0.00");

            textBoxSM_Amt.Text = SM_Unloaded.ToString("#,##0.00");

            textBoxDiff.Text = (CIT_Unloaded - SM_Unloaded).ToString("#,##0.00");

            if (G4.PresentedErrors > 0 )
            {
                labelPresenter.Show();
                textBoxPresenter.Show(); 
                textBoxPresenter.Text = G4.PresentedErrors.ToString("#,##0.00");
            }
            else
            {
                labelPresenter.Hide();
        ...
        private void ShowGrid1()
        {
            ...
            dataGridView1.Columns[2].Width = 60; // Repl_UnLoad_Status
            ...
            dataGridView1.Columns[14].HeaderText = "Cass_2";

            dataGridView1.Columns[15].Width = 60; //Un_Load_FaceValue_3  
            dataGridView1.Columns[15].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dataGridView1.Columns[15].HeaderText = "Denom_3";

            dataGridView1.Columns[16].Width = 60; // Un_Load_Cassette_3
            ...
            dataGridView1.Columns[16].HeaderText = "Cass_3";

            dataGridView1.Columns[17].Width = 60; //Un_Load_FaceValue_4 
            dataGridView1.Columns[17].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dataGridView1.Columns[17].HeaderText = "Denom_4";

            dataGridView1.Columns[18].Width = 60; // Un_Load_Cassette_ 
            ...
            dataGridView1.Columns[18].HeaderText = "Cass_4";
