...
namespace RRDM4ATMsWin
{
    public partial class Form20 : Form
    {
                               ...
                               string InChosenUserId, int InFunctionNo)
        {
            ...
            comboBox5.DataSource = Cc.GetBanksShortNames(WOperator);
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            //Create Password 
            WPassWord = Us.CreatePassword(8); // Here we insert a generated password 

            // Encrypt and Keep 
            Us.PassWord = Us.EncryptPassword(WPassWord); 
        ...
        {
            if (comboBox1.Text == "Make Selection") textBox3.Text = " ";
            ...
            if (comboBox1.Text == "ATM/Group Officer At Center(3)") textBox3.Text = "3";
            if (comboBox1.Text == "ATM/Group Officer At Branch(2)") textBox3.Text = "2"; 
