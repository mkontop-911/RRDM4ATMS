...
{
    public partial class Form291NV_E_FIN_Totals_XXXXX : Form
    {
        /// <summary>
        ...
        public Form291NV_E_FIN_Totals_XXXXX(string InSignedId, int SignRecordNo, string InOperator, string InSubSystem ,  int InReconcCycleNo )
        {
