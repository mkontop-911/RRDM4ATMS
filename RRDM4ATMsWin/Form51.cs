                ...
                case 7: // From Authorisation
                    {
                        ...
                        if (AutherPresent) // Electronic authorization needed  
                        {
                            ...
                            if ((WRequestor || WAuthoriser == true) & ReplenishmentAuthorDone == true & (Ap.Stage == 3 || Ap.Stage == 4)
                     ...
                     //   using (var scope = new System.Transactions.TransactionScope())
                            ...
                            if (Cv.RecordFound == true)
                            {
                                ...
                                {
                                    Ce.STATUS = "03"; // Completion Status 
