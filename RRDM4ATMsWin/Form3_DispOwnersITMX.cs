...
{
    public partial class Form3_DispOwnersITMX : Form
    {
     ...
     //   string WUserId;
        ...
        public Form3_DispOwnersITMX(string InSignedId, int SignRecordNo, string InOperator, int InDispId)
        {
