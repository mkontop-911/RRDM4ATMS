...
{
    public partial class Form21MIS_ATM_ROMANIA : Form
    {
        ...
        public Form21MIS_ATM_ROMANIA(string InSignedId, string InOperator, DateTime InDtFrom, DateTime InDtTo, int InAction)
        {
