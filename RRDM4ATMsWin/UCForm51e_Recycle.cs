...
{
    public partial class UCForm51e_Recycle : UserControl
    {
       ...
       bool  AudiType = false;
        ...
        public void UCForm51ePar_Recycle(string InSignedId, int InSignRecordNo, string InOperator, string InAtmNo, int InSesNo)
        {
            ...
            if (From_SM == "YES")
            {
                ...
                if (SM.RecordFound == true)
                {
                    ...
                    while (I <= (SM.DataTable_SM_Deposits.Rows.Count - 1))
                    {
                        ...
                        WTotal_SM_Notes = ((WTotalCassetteNotes + WRetractTotalNotes + WRECYCLEDTotalNotes) - WTotalNCR_DepositsDispensedNotes);
                        WTotal_SM_Money = ((WTotalCassetteMoney + WRetractTotalMoney + WRECYCLEDTotalMoney) - WTotalNCR_DepositsDispensedMoney);
                        ...
                        if (K == 1)
                        {
                            ...
                            textBoxCcy1CassetteAmountDiff.Text = (SM.TotalCassetteAmountCount - WTotal_SM_Money).ToString("#0.00");
