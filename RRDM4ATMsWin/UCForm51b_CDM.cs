...
{
    public partial class UCForm51b_CDM : UserControl
    {
        // Working variables
    ...
    //    NotesBalances Na = new NotesBalances(); // Class Notes 
        ...
        public void UCForm51b_CDM_Par(string InSignedId, int InSignRecordNo, string InOperator,  string InAtmNo, int InSesNo)
        {
