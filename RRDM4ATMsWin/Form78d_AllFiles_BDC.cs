    ...
    public partial class Form78d_AllFiles : Form
    {
      ...
      //  RRDMMatchingSourceFiles Msf = new RRDMMatchingSourceFiles();
...

        {
            ...
            Mpa.ReadMatchingTxnsMasterPoolBySelectionCriteria(WSelectionCriteria);
        ...
        private void Form78b_Load(object sender, EventArgs e)
        {
            ...
            {
                // It is a Trace
                TraceRRN = Mpa.AtmTraceNo; // WITH ZERO AT THE END
            ...
            {
                WRecordFoundInUniversal = Msr.FindRawRecordFromMasterRecord(WOperator, FileA, Mpa.MatchingAtRMCycle ,Mpa.TransDate.Date ,TerminalId, TraceRRN, 1);
            ...
            {
                // It is a Trace
                TraceRRN = Mpa.TraceNoWithNoEndZero; // WITH NO ZERO AT THE END
            }
            ...
            WRecordFoundInUniversal = Msr.FindRawRecordFromMasterRecord(WOperator, FileB, Mpa.MatchingAtRMCycle, Mpa.TransDate.Date, TerminalId, TraceRRN, 1);
            ...
            {
                dataGridView3.Show();
                WRecordFoundInUniversal = Msr.FindRawRecordFromMasterRecord(WOperator, FileC, Mpa.MatchingAtRMCycle, Mpa.TransDate.Date, TerminalId, TraceRRN, 1);
...
// Near Journal Lines 
        ...
        private void buttonJournal_Near_Click(object sender, EventArgs e)
        {
            ...
            Mpa.ReadInPoolTransSpecificNearAtmJournal(SelectionCriteria, WDt);
            ...
            SelectionCriteria = " WHERE TerminalId ='" + Mpa.TerminalId
                              + "' AND NotInJournal = 0 AND TransDate > @TransDate  ORDER By TransDate Asc ";
