...
{
    public partial class UCForm51c_SM_Recycle : UserControl
    {
        // Working variables
        ...
        public void UCForm51c_Recycle_Par_SM(string InSignedId, int InSignRecordNo, string InOperator, string InAtmNo, int InSesNo)
        {
            ...
            if (From_SM == "YES")
            {
                ...
                while (I <= (SM.DataTable_SM_Deposits.Rows.Count - 1))
                {
                    ...
                    if (WCcy == "EGP")
                    {
                        ...
                        textBoxCcy1CassetteNotes.Text = WTotal_SM_Notes.ToString("#0");
                        textBoxCcy1CassetteAmount.Text = WTotal_SM_Money.ToString("#0.00");
                        ...
                        if (TotValueBNA != WTotalMoneyDecimal)
                        {
                            ...
                            textBoxDep_SM.Text = (WTotalMoneyDecimal + WRECYCLEDTotalMoney).ToString("#,##0.00");
                            textBoxDep_Jrn.Text = TotValueBNA.ToString("#,##0.00");
                            textBoxDiff.Text = ((WTotalMoneyDecimal + WRECYCLEDTotalMoney) - TotValueBNA).ToString("#,##0.00");
                        }
                        else
                        {
                            //panelDepDiff.Hide();
                    ...
                    if (L == 2 & Is_L_2_Done == false)
                    {
                        ...
                        textBoxCcy2CassetteNotes.Text = WTotal_SM_Notes.ToString("#0");
                        textBoxCcy2CassetteAmount.Text = WTotal_SM_Money.ToString("#0.00");
                    ...
                    if (L == 3 & Is_L_3_Done == false)
                    {
                        ...
                        textBoxCcy3CassetteNotes.Text = WTotal_SM_Notes.ToString("#0");
                        textBoxCcy3CassetteAmount.Text = WTotal_SM_Money.ToString("#0.00");
                    ...
                    if (L == 4 & Is_L_4_Done == false)
                    {
                        ...
                        textBoxCcy4CassetteNotes.Text = WTotal_SM_Notes.ToString("#0");
                        textBoxCcy4CassetteAmount.Text = WTotal_SM_Money.ToString("#0.00");
        ...
        private void ValidateInputAndShowDifferences()
        {
            if (IsCcy_1 == true)
            {
                ...
                //TotalNCR_DepositsDispensedNotesCount 
