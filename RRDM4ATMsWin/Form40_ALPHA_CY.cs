    ...
    public partial class Form40_ALPHA_CY : Form
    {
        ...
        public Form40_ALPHA_CY()
        {
           ...
           // Reconciliator_Form = "BDC";
            ...
            if (WBankShortName == "AUD" || WBankShortName == "BT" || WBankShortName == "ALP")
            {
            ...
            if (Gp.OccuranceNm == "YES") // Active directory needed
            {
                ...
                if (WActiveDirectory == true)
                {
                    ...
                    if (WBankShortName == "BDC")
                    {
                        string WParamId = "805"; // Show ALL FOR DINA AND OSMAN
                    ...
                    label6.Text = "Make Selection and Press Proceed ";
                    label7.Text = "";
        ...
        private void buttonLogin_Click(object sender, EventArgs e)
        {
           ...
           if (WBankShortName == "EGA")
            ...
            //MessageBox.Show("DINA: Report this message that you had reach 166 ");
            ...
            //MessageBox.Show("DINA: Report this message that you had reach 167 "); 
            ...
            if (WActiveDirectory == true)
            {
                //MessageBox.Show("DINA: Report this message that you had reach 168 " );
                if (AD_ShowAll == true & radioButtonController.Checked == true) // Coming from Dina or Osman
                {
                    //MessageBox.Show("DINA: Report this message that you had reach 169 ");
                    // Make-Upgrate  Security level to 08 as Controller 
                    WSecLevel = "08";

                    //if (Environment.MachineName != "CARDSD160")
                    //{
