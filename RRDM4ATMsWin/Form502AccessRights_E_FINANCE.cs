...
{
    public partial class Form502AccessRights_E_FINANCE : Form
    {
        ...
        public Form502AccessRights_E_FINANCE(string InSignedId, int InSignRecordNo, string InOperator, int InMode)
        {
...
// Load 
        private void Form502_Load(object sender, EventArgs e)
        {
            ...
            WSelectionCriteria = " WHERE Operator ='" + WOperator + "'" 
                                + " AND MainFormId = 'Form1 - E-FINANCE RECONCILIATION'"
                                + " ORDER BY PanelName ";
