...
{
    public partial class Form1ITMXCBT : Form
    {
        ...
        public Form1ITMXCBT(string InSignedId, int SignRecordNo, string InSecLevel, string InOperator)
        {
...
// LOAD
        private void Form1ITMXCBT_Load(object sender, EventArgs e)
        {
            // NOTES 
            ...
            if (checkBox1.Checked == true)
            {
                ...
                //Define Banks 
                toolTipButtons.SetToolTip(button13, "Within Banks' record Define settlement accounts." + Environment.NewLine
                                             + "These can be viewed by ITMX but amended only by Central Bank."
                                             );

                //Users and CIT providers.   
                toolTipButtons.SetToolTip(button54, "Define Users for Central Bank." + Environment.NewLine
                                             + "Define authorisers." + Environment.NewLine
                                             + "Set access rights at functionality."
                                             );
                ...
                toolTipButtons.SetToolTip(button44, "FT Settlement totals status is presented." + Environment.NewLine
                                             + "Status is Authorised." + Environment.NewLine
                                             + "Transactions to Be Posted are created"
                                             );

                //Settlement and Creation of transctions with authorisation 
                toolTipButtons.SetToolTip(button46, "Fees Settlement totals status is presented." + Environment.NewLine
                                             + "Status is Authorised." + Environment.NewLine
                                             + "Transactions to Be Posted are created"
                                             );
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (checkBox1.Checked)
            {
                ...
                Form1ITMXCBT_Load(this, new EventArgs());
            }
            else
            {
        ...
        private void checkBox3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                // False
                if (checkBox2.Checked == false & checkBox4.Checked == false & checkBox5.Checked == false & checkBox6.Checked == false & checkBox7.Checked == false)
                {
                    panel6.Hide();
                }
            }
        ...
        private void checkBox4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                // False
                if (checkBox2.Checked == false & checkBox3.Checked == false & checkBox5.Checked == false & checkBox6.Checked == false & checkBox7.Checked == false)
                {
                    panel6.Hide();
                }
            }
        ...
        private void checkBox5_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                // False
                if (checkBox2.Checked == false & checkBox3.Checked == false & checkBox4.Checked == false & checkBox6.Checked == false & checkBox7.Checked == false)
                {
                    panel6.Hide();
                }
            }
        ...
        private void checkBox6_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                // False
                if (checkBox2.Checked == false & checkBox3.Checked == false & checkBox4.Checked == false & checkBox5.Checked == false & checkBox7.Checked == false)
                {
                    panel6.Hide();
                }
            }
        ...
        private void checkBox7_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox7.Checked == true)
            {
                ...
                checkBox5.Checked = false;
                checkBox6.Checked = false;
                button20.Text = "Settlement Totals";
                button11.Text = "Authorisation and Txns";
                button14.Text = "Posting";
            }
            else
            {
                // False
