...
{
    class RRDMAllowedAtmsAndUpdateFromJournal
    {
    ...
    //  FormProcessing NFormProcessing;
       ...
       //    Application.DoEvents();
        ...
        public void UpdateLatestEjStatusForSpecificAtm(string InSignedId, int InSignRecordNo, string InOperator, string InAtmNo )
        {
            WSignedId = InSignedId;
            WSignRecordNo = InSignRecordNo;
            WOperator = InOperator;
