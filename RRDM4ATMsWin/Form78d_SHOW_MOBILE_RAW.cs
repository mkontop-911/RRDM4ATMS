...
{
    public partial class Form78d_SHOW_MOBILE_RAW : Form
    {
        ...
        public Form78d_SHOW_MOBILE_RAW(string InSignedId, long inSeqNo 
                                               ,string InFileId,string InApplication)
        {
        ...
        private void Form78b_Load(object sender, EventArgs e)
        {
                ...
                int DB_Mode = 1; // Single File 
            //    [ETISALAT].[dbo].[BULK_ETISALAT_MEEZA_TXNS_ALL]
                 WTableName = W_Application + ".[dbo].BULK_" + WFileId + "_ALL";
                ...
                labelWhatGrid.Text = "RAW Input Data For.."+ WFileId;
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ////WTableName 
            //Mmob.ReadTransSpecificFromSpecificTable_MOBILE_2(WWSelectionCriteria, WTableName, WTableName_MATCHED, 2); 
