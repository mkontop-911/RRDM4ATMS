...
{
    public partial class Form112_OLD : Form
    {
        Form109 NForm109;
        Form110 NForm110;
        Form51 NForm51;
        ...
        public Form112_OLD(string InSignedId, int InSignRecordNo, string InOperator, string InFunction,
                ...
                case "LoadingExcel":
                    {
                        ...
                        NForm276_NBG = new Form276_NBG(WSignedId, WSignRecordNo, WOperator, WRMCateg, WRMCycle);
                        NForm276_NBG.FormClosed += NForm271_FormClosed;
