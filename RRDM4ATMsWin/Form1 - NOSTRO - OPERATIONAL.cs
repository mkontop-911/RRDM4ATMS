...
{
    public partial class Form_NOSTRO_OPERATIONAL : Form
    {
        ...
        public Form_NOSTRO_OPERATIONAL(string InSignedId, int SignRecordNo, string InSecLevel, string InOperator)
        {
