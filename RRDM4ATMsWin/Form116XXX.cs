...
{
    public partial class Form116XXX : Form
    {
        Form5 NForm5;
        ...
        public Form116XXX(string InSignedId, int InSignRecordNo, string InOperator)
        {
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Dt.ReadDisputeTranByUniqueRecordId(WTranNo);
        ...
        private void dataGridView2_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            // Read From merge file
            //
            Mt.ReadMergeFileCard(WOperator, SelMode, WEnteredNumber, From, To, Ec.UniqueRecordId);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            NForm67 = new Form67(WSignedId, WSignRecordNo, WOperator, JournalId, 0, WAtmNo, Tc.MasterTraceNo, Tc.AtmTraceNo, Mode);
            NForm67.ShowDialog();
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            RRDMJournalReadTxtClass Jt = new RRDMJournalReadTxtClass();
