...
{
    public partial class Form291ITMX : Form
    {
        /// <summary>
        ...
        public Form291ITMX(string InSignedId, int SignRecordNo, string InOperator)
        {
            ...
            // Create Actions for Unsettled - UnMatched

            Mp.ReadTableUnMatchedForDefaultActions(WOperator, WSignedId, WReconcCycleNo); 

            //Load Data Table For Grid
            int Mode = 3;
            Mre.ReadMatchingReconcExceptionsInfoToFillTable(WOperator, "", WReconcCycleNo, Mode);
            //Show Table
            ShowGrid();

            //Ap.ReadAuthorizationForReplenishmentReconcSpecific(WReconcCategoryId, WReconcCycleNo, "ConfirmNostroMatching"); //
            ...
            WReconcCategoryId = "ITMX";
            MessageBox.Show("Check code for this line"); 
            ...
            Usi.WFieldChar1 = WReconcCategoryId;
            ...
            {
                bool Reject = false;
                Ap.GetMessageReconCateg(WReconcCategoryId, WReconcCycleNo, "ConfirmNostroMatching", WAuthoriser, WRequestor, Reject);
        ...
        public void SetScreen()
        {
            ...
            if (WRequestor == true) // Comes from Author management Requestor
            {
                ...
                Ap.ReadAuthorizationForReplenishmentReconcSpecificForCategoryAndCycle(WReconcCategoryId, WReconcCycleNo, "ConfirmNostroMatching");
        ...
        private void buttonAuthor_Click_1(object sender, EventArgs e)
        {
            ...
            Ap.ReadAuthorizationForReplenishmentReconcSpecificForCategoryAndCycle(WReconcCategoryId, 
            ...
            NForm110 = new Form110(WSignedId, WSignRecordNo, WOperator, WOrigin, WTranNo, WReconcCategoryId, WReconcCycleNo, AuthorSeqNumber,0,"",0 ,"Normal");
...
//Finish 
        ...
        {
            MessageBox.Show("At this point the Default Adjastments are finalised. The rejected will remain for the detail reconciliation");
            this.Dispose(); 
        }
    }
}
