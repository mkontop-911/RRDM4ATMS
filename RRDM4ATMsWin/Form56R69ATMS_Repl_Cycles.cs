...
{
    public partial class Form56R69ATMS_Repl_Cycles : Form
    {
        string WR1;
        string WR2;
        string WR3; // ATM NO
        ...
        public Form56R69ATMS_Repl_Cycles(string R1, string R2, string R3, string R4, string R5)
        {
            WR1 = R1;
            WR2 = R2;
            WR3 = R3;
        ...
        private void Form56R34ITMX_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string RSReportName = RsDir + "/ATMSViewReplCycles_Audi";
              //  string RSReportName = "/ATMSViewReplCycles_Audi";
        ...
        private ArrayList ReportDefaultPatam()
        {
            ...
            arrLstDefaultParam.Add(CreateReportParameter("Par3_ATMNo", WR3));
