...
{
    public partial class Form1ATMs_Reconciliator_EGATE : Form
    {
        ...
        public Form1ATMs_Reconciliator_EGATE(string InSignedId, int SignRecordNo, string InSecLevel, string InOperator)
        {
        ...
        // Category View 
        private void buttonCategoryView_Click(object sender, EventArgs e)
        {
            Form80a3 NForm80a3;
            string WFunction = "View";
            string Category = "All";
