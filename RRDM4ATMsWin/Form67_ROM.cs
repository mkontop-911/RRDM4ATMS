...
{
    public partial class Form67_ROM : Form
    {
        ...
        public Form67_ROM(string InSignedId, int InSignRecordNo, string InOperator, int InFuid, string InTraceOrRRNumber
        ...
        private void Form67_Load(object sender, EventArgs e)
        {
            ...
            if (WMode == 5 & NoUpperLimit == false)
            {
                ...
                {
                    Ej.ReadJournalTxnsBySeqNoAndFind_Start_End_ROM(WOperator, WSeqNoA, 1);
                }
