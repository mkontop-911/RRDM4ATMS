...
{
    public partial class FormMainScreenSwitch : Form
    {
        ...
        public FormMainScreenSwitch(string InSignedId, int SignRecordNo, string InSecLevel, string InOperator)
        {
        ...
        private void FormMainScreenSwitch_Load(object sender, EventArgs e)
        {
            // NOTES 
            ...
            if (checkBox1.Checked == true)
            {
                ...
                toolTipButtons.SetToolTip(button54, "Define Users for ITMX." + Environment.NewLine
                                             + "Define seed users for Banks." + Environment.NewLine
                                             + "Define access role levels.."
                                             );
                ...
                //Fees definition 
                toolTipButtons.SetToolTip(button47, "Fees Version and Layers Definition" + Environment.NewLine
                                             + "Future changes in fees are defined as new versions." + Environment.NewLine
                                             + "For each version layers of fees are defined." + Environment.NewLine
                                             + "Fees are divided to the involved entities."
                                             );
                //Settlement Totals 
                ...
                toolTipButtons.SetToolTip(button86, "Reconcilition Categories in difference are shown." + Environment.NewLine
                ...
                //Reconciliation 
                toolTipButtons.SetToolTip(button96, "Reconciliation Categories workflow." + Environment.NewLine
                                             + "Actions by user are taken during this three step workflow." + Environment.NewLine
                                             + "Actions are authorised and tnxs for posting, disputes or SMS are created"
                                             );

                //View 
                toolTipButtons.SetToolTip(button96, "Rich searching engine for transactions." + Environment.NewLine
                                             + "All exceptions can be seen too." + Environment.NewLine
                                             + "What you can see you can print"
                                             );
                ...
                //Cut Off 
                toolTipButtons.SetToolTip(button42, "At cut off do:" + Environment.NewLine
                ...
                //Files Loading
                toolTipButtons.SetToolTip(button43, "Start Files loading" + Environment.NewLine
                                             + "a) For each loaded file make validation against open ticket" + Environment.NewLine
                                             + "b) If not valid send a message to sender and update Loading counter of wrong files " + Environment.NewLine
                                             + "c) If valid create a record and update/close loading ticket" + Environment.NewLine
                                             + "d) .... create wi"
                                             );

                //Settlement and Creation of transctions with authorisation 
                toolTipButtons.SetToolTip(button44, "View settlement todtals ." + Environment.NewLine
                                             + " ITMX and Settlement Bank Can view all where as other banks only theirs" + Environment.NewLine
                                             + " Ask for authorization and create transactions" + Environment.NewLine
                                             + " Go to transactions to be posted and post transactions."
                                             );
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (checkBox1.Checked)
            {
                ...
                FormMainScreenSwitch_Load(this, new EventArgs());
            }
            else
            {
        ...
        {
            Form80aITMX NForm80a;
            string WFunction = "Reconc";
            NForm80a = new Form80aITMX(WSignedId, WSignRecordNo, WOperator, WFunction, "ALL");
        ...
        private void button83_Click(object sender, EventArgs e)
        {
            ...
            NForm502a = new Form502a(WSignedId, WSignRecordNo, WOperator);
            NForm502a.ShowDialog();
        }
        // DEFINE CATEGORIES  
        ...
        private void button86_Click(object sender, EventArgs e)
        {
            ...
            Form80cITMX NForm80cITMX;
            string WFunction = "Allocate";
            NForm80cITMX = new Form80cITMX(WSignedId, WSignRecordNo, WOperator, WFunction);
            NForm80cITMX.ShowDialog();
        }
        ...
        {
            //Form502_XXX NForm502;

            //NForm502 = new Form502_XXX(WSignedId, WSignRecordNo, WOperator);
            //NForm502.ShowDialog();
        ...
        private void button96_Click(object sender, EventArgs e)
        {
            ...
            NForm80aITMX.FormClosed += NForm80aITMX_FormClosed;

            NForm80aITMX.ShowDialog();
        }

        private void NForm80aITMX_FormClosed(object sender, FormClosedEventArgs e)
        {
            FormMainScreenSwitch_Load(this, new EventArgs());
        }
        //Call Categories 
        ...
        //MetaExceptions Definition 
        private void button8_Click(object sender, EventArgs e)
        {
            Form502bITMX NForm502bITMX;
            string ReconciliationCategoryId = "BBL TO KBANK";
            NForm502bITMX = new Form502bITMX(WSignedId, WSignRecordNo, WOperator, ReconciliationCategoryId);
            NForm502bITMX.ShowDialog();
        }
        // SETTLEMENT 
        ...
        //Settlement Txns Creation 
        private void button44_Click(object sender, EventArgs e)
        {
            //MessageBox.Show("THIS FUNCTIONALITY IS ONLY FOR CENTRAL BANK OF THAILAND.");
            //    return; 
        ...
        // Configure 
        private void button84_MouseHover(object sender, EventArgs e)
        {
            checkBox2.Checked = true;
            checkBox3.Checked = checkBox4.Checked = checkBox5.Checked = checkBox6.Checked = false;
        }

        private void button83_MouseHover(object sender, EventArgs e)
        {
            checkBox2.Checked = true;
            checkBox3.Checked = checkBox4.Checked = checkBox5.Checked = checkBox6.Checked = false;
        }
        // allocation  
        private void button86_MouseHover(object sender, EventArgs e)
        {
            checkBox3.Checked = true;
            checkBox2.Checked = checkBox4.Checked = checkBox5.Checked = checkBox6.Checked = false;
        }
        // Reconciliation 
        private void button96_MouseHover(object sender, EventArgs e)
        {
            checkBox4.Checked = true;
            checkBox2.Checked = checkBox3.Checked = checkBox5.Checked = checkBox6.Checked = false;
        }
        //View and Disputes 
        ...
        {
            Form200bITMX NForm200bITMX;

            string RunningGroup = "ITMX-FT";
            NForm200bITMX = new Form200bITMX(WSignedId, WSignRecordNo, WSecLevel, WOperator, RunningGroup);
            NForm200bITMX.ShowDialog(); 
...
//This FEES Transaction Creation 
        private void button46_Click(object sender, EventArgs e)
        {
            MessageBox.Show("This function is only available to the Central Bank personel.");
            return; 
        }
// Fees Settlement Totals
...
// DEFAULT ADJUSTMENTS 
        private void button8_Click_1(object sender, EventArgs e)
        {
            ...
            return; 
            Form291ITMX NForm291ITMX;

            NForm291ITMX = new Form291ITMX(WSignedId, WSignRecordNo, WOperator); 
            NForm291ITMX.ShowDialog();
        }
// Universal Files Definition 
