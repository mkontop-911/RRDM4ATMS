...
{
    public partial class Form291NVConfirmed_Cards : Form
    {
        ...
        public Form291NVConfirmed_Cards(string InSignedId, int SignRecordNo, string InOperator, 
        ...
        private void Form291_Load(object sender, EventArgs e)
        {
            ...
            Sec.ReadNVCardRecordsForBothByMode(WOperator, WSignedId, WSubSystem, Mode, WReconcCycleNo, ExternalAcc, InternalAcc, "", NullPastDate, "");
            ...
            {
                bool Reject = false;
                Ap.GetMessageReconCateg("AllCategories", WReconcCycleNo, "ConfirmNostroMatching", WAuthoriser, WRequestor, Reject);
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (Sec.ActionType == "00")
            {
                buttonUnDo.Show();
                buttonReDo.Hide();
            }
            if (Sec.ActionType == "08")
            {
                buttonUnDo.Hide();
                buttonReDo.Show();
            }
        ...
        private void buttonUnDo_Click(object sender, EventArgs e)
        {
            ...
            Sec.ActionType = "08"; // Action Type 8 = it was default and it will become 
            Sec.UpdateUndoConfirmedExternal(WOperator, WUniqueMatchingNo);
            Sec.UpdateUndoConfirmedInternal(WOperator, WUniqueMatchingNo);
        ...
        public void SetScreen()
        {
            ...
            if (WRequestor == true) // Comes from Author management Requestor
            {
                ...
                Ap.ReadAuthorizationForReplenishmentReconcSpecificForCategoryAndCycle("AllCategories", WReconcCycleNo, "ConfirmNostroMatching");
        ...
        private void buttonAuthor_Click_1(object sender, EventArgs e)
        {
            ...
            NForm110 = new Form110(WSignedId, WSignRecordNo, WOperator, WOrigin, WTranNo, "AllCategories", WReconcCycleNo, AuthorSeqNumber,0,"",0, "Normal");
        ...
        private void buttonAuthHistory_Click_1(object sender, EventArgs e)
        {
            ...
            NForm112 = new Form112(WSignedId, WSignRecordNo, WOperator, "History", "AllCategories", WReconcCycleNo, WDisputeNo, WDisputeTranNo, "AllCategories", WReconcCycleNo);
            NForm112.ShowDialog();
        }
        // Show Grid Left 
        public void ShowGrid()
        {
            ...
            dataGridView1.Columns[2].Width = 40; // ColorNo
        ...
        private void buttonFinish_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Ap.RecordFound == true & Ap.Stage == 4)
                {
                    ...
                    while (K <= (dataGridView1.Rows.Count - 1))
                    {
                        ...
                        if (LOrigin == "EXTERNAL")
                        {
                            ...
                            if (LDONE == "YES")  
                            {
                                ...
                                Sec.UserId = WSignedId;
                                Sec.Authoriser = Ap.Authoriser; 
                        ...
                        if (LOrigin == "INTERNAL" || LOrigin == "WAdjustment")
                        {
                            ...
                            if (LDONE == "YES")
                            {
                                ...
                                {                                  
                                    Ec.CreateTransTobepostedfromVisa(WSignedId, Ap.Authoriser ,WCategoryId ,InternalAcc,
                                                LSeqNo ); 
                                }
                                // Create Transaction to be posted 
                            }
                            ...
                            if (LDONE == "NO")
                            {
                                if (LOrigin == "WAdjustment")
                                {
                                    Sec.DeleteAdjustmentsForInternal(LSeqNo);
                                }
                                else
                                {
                                    Sec.Matched = false;
                    ...
                    Sec.ReadNVExternalStatements_LinesForTotals(WOperator, WSignedId, WSubSystem, WReconcCycleNo,
                                            ExternalAcc, WStmtTrxReferenceNumber, WDate);

                    // Find ALerts and Disputes 
                    int Mode = 12; // All Un matched this cycle 
                    Sec.ReadNVCardRecordsForBothByMode(WOperator, WSignedId, WSubSystem, Mode, WReconcCycleNo, "", "", "", WDate, "");
                    ...
                    Rcs.UpdateReconcCategorySessionWithAutomaticMatchTotals(WRcsSeqNo,
                          ...
                          Sec.UnMatchedAmt, Sec.MatchedFromAutoToBeConfirmed, Sec.MatchedFromManualToBeConfirmed, Sec.OutstandingAlerts, Sec.OutstandingDisputes, DateTime.Now);
