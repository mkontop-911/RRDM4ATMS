...
{
    public partial class Form277_MOBILE : Form
    {
        ...
        public Form277_MOBILE(string InSignedId, int InSignRecordNo, string InOperator, string InCategory, int InRMCycle, string InW_Application)
        {
            ...
            )
            {
                ...
                //{
                UCForm277b_MOB Step277a = new UCForm277b_MOB();
                ...
                Step277a.UCForm277b_MOB_Par(WSignedId, WSignRecordNo, WOperator, WCategory, WRMCycle, W_Application);
                Step277a.SetScreen();
