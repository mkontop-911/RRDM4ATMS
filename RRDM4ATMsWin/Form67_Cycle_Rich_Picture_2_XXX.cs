...
{
    public partial class Form67_Cycle_Rich_Picture_2_XXX : Form
    {
        ...
        public Form67_Cycle_Rich_Picture_2_XXX(string InSignedId, string InOperator, string InAtmNo,
        ...
        private void Form67_Load(object sender, EventArgs e)
        {
            ...
            if (WMode == 12)
            {
                ...
                labelHeaderLeft.Text = "ALL EXCESS CYCLES FROM.." + WFromDt.ToShortDateString()
        ...
        private void ShowGrid()
        {
            ...
            dataGridView2.Columns[2].Width = 75; // CYCLE START DATE 
            dataGridView2.Columns[2].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            dataGridView2.Columns[2].HeaderText = "Start_Date";

            dataGridView2.Columns[3].Width = 75; // End_DATE
            dataGridView2.Columns[3].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            dataGridView2.Columns[3].HeaderText = "End_Date";

            dataGridView2.Columns[4].Width = 75; // EXCESS or Shortage
            dataGridView2.Columns[4].DefaultCellStyle.Format = "#,##0.00";
            dataGridView2.Columns[4].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            dataGridView2.Columns[5].Width = 75; // Refunded or Recovered
            ...
            dataGridView2.Columns[6].Width = 75; // Net Amount
        ...
        private void ShowGrid_2()
        {
            ...
            {
                MessageBox.Show("Nothing to SHOW");
                textBoxTotal.Text = Aoc.TxnsTableAllCycles_Details_2.Rows.Count.ToString();
                return;
            }
            else
            {
