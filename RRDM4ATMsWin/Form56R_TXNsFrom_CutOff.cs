...
{
    public partial class Form56R_TXNsFrom_CutOff : Form
    {
        string WR1;
        string WR2;
        string WR3;
        ...
        public Form56R_TXNsFrom_CutOff(string R1, string R2, string R3, string R4, string R5)
        {
            WR1 = R1;
            WR2 = R2;
            WR3 = R3;
        ...
        private void Form56R34ITMX_Load(object sender, EventArgs e)
        {
            //ShowReport();
            ...
            try
            {
                ...
                string RSReportName = RsDir + "/ATMS_Txns_From_Cut_To_Repl";
        ...
        private ArrayList ReportDefaultPatam()
        {
            ...
            arrLstDefaultParam.Add(CreateReportParameter("Header", WR1));
            arrLstDefaultParam.Add(CreateReportParameter("AtmNo", WR2));
            arrLstDefaultParam.Add(CreateReportParameter("ReplCycle", WR3));
