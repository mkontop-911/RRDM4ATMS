...
{
    public partial class Form78d_AllFiles_BDC_3_ROM : Form
    {
        ...
        public Form78d_AllFiles_BDC_3_ROM(string InOperator, string InSignedId, int InUniqueRecordId, int InMode)

        {
            ...
            if (WMode == 1 || WMode == 4)
            {
                ...
                else
                {
                    ...
                    labelWhatGrid.Text = "ORIGINAL DATA FOR UTRNNO : " + Mpa.UTRNNO + " AND MASK :" + Mpa.MatchMask;
                    IsUTRNNOBased = true;
                }           
            }
        ...
        private void Form78b_Load(object sender, EventArgs e)
        {
            ...
            if (WOrigin == "Our Atms")
            {
                ...
                if (WMode == 1 || WMode == 2)
                {
                    Msr.FillTablesProcessForJournal_ROM(WTerminalId, Mpa.UTRNNO);
                }
            ...
            else
            {
                if (RRNBased == true)
                {
                    ...
                    if (WMode == 1 || WMode == 2)
                    {
                        WRecordFoundInUniversal = Mgt.FindRecordsFromMasterRecord_ROM
                            (WTerminalId, WRRNumber, Mpa.UTRNNO, FileA, 5, 2);
                        ...
                        if (Mgt.RecordFound == false & FileA != "MEEZA_GLOBAL_LCL" & WMatchingCateg != "EMR204") 
                        {
            ...
            else
            {
                if (IsUTRNNOBased)
                {
                    ...
                    {
                        WRecordFoundInUniversal = Mgt.FindRecordsFromMasterRecord_ROM
                            ( WTerminalId, WRRNumber, Mpa.UTRNNO, FileB, 1, 2);
