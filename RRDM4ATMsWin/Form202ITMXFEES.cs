...
{
    public partial class Form202ITMXFEES : Form
    {
        ...
        int WSignRecordNo;
        string WOperator;
        public Form202ITMXFEES(string InSignedId, int SignRecordNo, string InOperator)
        {
            ...
            {
                ITMXUser = true;
                labelStep1.Text = "Banks Settlement FEES Statement ";
                textBoxMsgBoard.Text = "Select Bank And Settlement Cycles Range. ";
            }
            else
            {
                ITMXUser = false;

                labelStep1.Text = "Settlement FEES Statement For : " + Us.BankId;

                textBoxMsgBoard.Text = "Select Corresponding Bank And Settlement Cycles range. ";

                Ba.ReadBank(Us.BankId);
                if (Ba.SettlementBank == true)
                {
                    ClearingBank = true;
                    labelStep1.Text = "Banks Settlement Fess Statement ";
...
// Go to Next  
        ...
        private void ShowGrid1(string Operator)
        {
            ...
            {
                //SelectionCriteria = " WHERE Operator ='" + WOperator + "' AND BankId ='" + Us.BankId +"'";
        ...
        private void ShowGrid2(string InBankId, int InFromCycleNo, int ToCycleNo)
        {
            if (ITMXUser == true || ClearingBank == true)
            {
                ...
                label3.Text = "SETTLEMENT FEES CYCLES TOTALS FOR : " + InBankId; 
            }
            else
            {
                label3.Text = "SETTLEMENT FEES CYCLES TOTALS " ;
            }
            SFT.ReadTableFeesTotalsForABankOverAllSettlements(WOperator, WSignedId, InBankId, InFromCycleNo, ToCycleNo);
            //BBT.ReadTableTotalsForABankOverAllSettlements(WOperator, InBankId, InFromCycleNo, ToCycleNo);
            
            dataGridView2.DataSource = SFT.TableTotalsFeesForBank.DefaultView;
            ...
            chart2.DataSource = SFT.TableTotalsFeesForBank.DefaultView;
...
//Print NET Position 
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            string P4 = Us.BankId;
            string P5 = "PER CYCLE NET FEES POSITION FOR BANK : ";
            string P6 = WSignedId;
