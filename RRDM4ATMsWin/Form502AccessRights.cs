...
{
    public partial class Form502AccessRights : Form
    {
        ...
        public Form502AccessRights(string InSignedId, int InSignRecordNo, string InOperator, int InMode)
        {
            ...
            Gp.ReadParametersSpecificId(WOperator, "803", "02", "", "");
            textBox1.Text = Gp.OccuranceNm;

            Gp.ReadParametersSpecificId(WOperator, "803", "03", "", "");
            textBox2.Text = Gp.OccuranceNm;
            Gp.ReadParametersSpecificId(WOperator, "803", "04", "", "");
            textBox3.Text = Gp.OccuranceNm;
            Gp.ReadParametersSpecificId(WOperator, "803", "05", "", "");
            textBox4.Text = Gp.OccuranceNm;
            Gp.ReadParametersSpecificId(WOperator, "803", "06", "", "");
            textBox5.Text = Gp.OccuranceNm;
            Gp.ReadParametersSpecificId(WOperator, "803", "07", "", "");
            textBox6.Text = Gp.OccuranceNm;
            Gp.ReadParametersSpecificId(WOperator, "803", "08", "", "");
            textBox7.Text = Gp.OccuranceNm;
            Gp.ReadParametersSpecificId(WOperator, "803", "09", "", "");
            textBox8.Text = Gp.OccuranceNm;
            Gp.ReadParametersSpecificId(WOperator, "803", "10", "", "");
            textBox9.Text = Gp.OccuranceNm;
            Gp.ReadParametersSpecificId(WOperator, "803", "11", "", "");
            textBox10.Text = Gp.OccuranceNm;
            Gp.ReadParametersSpecificId(WOperator, "803", "12", "", "");
