...
{
    public partial class Form56R30ITMX : Form
    {
        string WR1;
        string WR2;
        string WR3;
        ...
        public Form56R30ITMX(string R1, string R2, string R3, string R4, string R5, string R6)
        {
            WR1 = R1;
            WR2 = R2;
            WR3 = R3;
        ...
        private void Form56R30ITMX_Load(object sender, EventArgs e)
        {
            //ShowReport();
            ...
            try
            {
                ...
                string RSReportName = RsDir + "/ITMXReport30";
        ...
        private ArrayList ReportDefaultPatam()
        {
            ...
            arrLstDefaultParam.Add(CreateReportParameter("BankId", WR1));
            arrLstDefaultParam.Add(CreateReportParameter("FromCycle", WR2));
            arrLstDefaultParam.Add(CreateReportParameter("ToCycle", WR3));
            arrLstDefaultParam.Add(CreateReportParameter("InBankIdLogo", WR4));
            arrLstDefaultParam.Add(CreateReportParameter("Heading", WR5));
