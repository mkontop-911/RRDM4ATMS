...
{
    public partial class Form502aPOS_XXX : Form
    {
        ...
        public Form502aPOS_XXX(string InSignedId, int SignRecordNo, string InOperator, 
        ...
        private void Form502a_Load(object sender, EventArgs e)
        {
            ...
            Mg.ReadMergedTXNWithOthers(TableA, TableB, WCategoryId, WMode); 
            ...
            GTotal2 = Mg.TotalEXT_Amt + Mg.TotalINT_Amt;
        ...
        private void buttonRemove_Click_1(object sender, EventArgs e)
        {
            ...
            if (WOrigin2 == "EXTERNAL")
            {
                Mg.UpdateActionTypeBySeqNo(WTable, WSeqNo2, WActionType);
            }
        ...
        private void buttonAddAdjust_Click(object sender, EventArgs e)
        {
            ...
            Mg.LoadedAtRMCycle = WReconcCycleNo; 
        ...
        private void checkBox5_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (decimal.TryParse(textBoxAmt.Text, out WAmnt))
            {
                ValidAmt = true;
            }
            else
...
// Ref is checked
        private void checkBoxSameRef_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBoxSameRef.Checked == true)
            {
                checkBoxSameAmt.Checked = false;
...
// Amt is checked
        private void checkBoxSameAmt_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBoxSameAmt.Checked == true)
            {
                checkBoxSameRef.Checked = false;
                checkBoxCard.Checked = false;
            }
        }
// Card is checked 
