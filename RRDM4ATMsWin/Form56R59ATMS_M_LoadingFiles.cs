...
{
    public partial class Form56R59ATMS_M_LoadingFiles : Form
    {
        string WR1;
        string WR2;
        string WR3;
        ...
        public Form56R59ATMS_M_LoadingFiles(string R1, string R2, string R3)
        {
            WR1 = R1;
            WR2 = R2;
            WR3 = R3;
        ...
        private void Form56R34ITMX_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string RSReportName = RsDir + "/LoadedFilesPrinting_ALL";
        ...
        private ArrayList ReportDefaultPatam()
        {
            ...
            arrLstDefaultParam.Add(CreateReportParameter("InBankIdLogo", WR2));
            arrLstDefaultParam.Add(CreateReportParameter("RMCycle", WR3));
