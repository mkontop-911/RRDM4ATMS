...
{
    public partial class UCForm71c : UserControl
    {
   ...
   //     ErrorsClass Pa = new ErrorsClass(); // Make class availble 
        ...
        public void UCForm71cPar(string InSignedId, int SignRecordNo, string InOperator, string InAtmNo, int InSesNo)
        {
            ...
            InitializeComponent();
            // Read if difference from previous step
