...
{
    public partial class Form12_YEAR_XXXX : Form
    {
        ...
        public Form12_YEAR_XXXX(string InSignedId, int SignRecordNo, string InSecLevel, string InOperator, int InAction)
        {
        ...
        private void ButtonUpdateAll_Click(object sender, EventArgs e)
        {
            ...
            while (K <= (dataGridView1.Rows.Count - 1))
            {
                ...
                else
                {
                    ...
                    Cm.Previous_Month_OR_Year = 2; // Previous Year Record
