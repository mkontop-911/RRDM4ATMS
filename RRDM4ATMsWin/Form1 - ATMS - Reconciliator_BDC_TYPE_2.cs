...
{
    public partial class Form1ATMs_Reconciliator_BDC_TYPE_2 : Form
    {
        ...
        public Form1ATMs_Reconciliator_BDC_TYPE_2(string InSignedId, int SignRecordNo, string InSecLevel, string InOperator)
        {
            ...
            //if (Usi.SecLevel == "03" & Usr.ReconcOfficer)
            //{
            //    Ua.FindIfUserHasATMs(WSignedId);

            //    if (Ua.RecordFound == false)
            //    {
            //        // The user doesnot have ATMs
            //        Replenishment.Hide();
            //    }
