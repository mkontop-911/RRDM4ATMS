...
{
    public partial class Form1ATMs : Form
    {
        ...
        public Form1ATMs(string InSignedId, int SignRecordNo, string InSecLevel, string InOperator)
        {
                ...
                || WSignedId == "NBG_005")
            {
                ...
                // ATMsInNeed 
                foreach (Control c in ATMsInNeed.Controls)
                {
                    if (c is Button)
                    {
                ...
                // MIS
                foreach (Control c in MIS.Controls)
                {
                    if (c is Button)
                    {
                ...
                // Quality
                foreach (Control c in Quality.Controls)
                {
                    if (c is Button)
                    {
            ...
            toolTipButtons.SetToolTip(labelMIS,
                                      "System's rich information is available to produce MIS reports " + Environment.NewLine
                                          + "Turnover" + Environment.NewLine
                                          + "Problems" + Environment.NewLine
                                          + "CIT performance" + Environment.NewLine
                                          + "Personel performance " + Environment.NewLine
                                          + "ATMs Profitability " + Environment.NewLine
                                          + ".............."
                                         );

            toolTipButtons.SetToolTip(labelQuality,
                                     "Quality is part of the system " + Environment.NewLine
                                          + "Status of KPI Indicators " + Environment.NewLine
                                          + "Own Performance System analysis" + Environment.NewLine
                                          + "Health Check" + Environment.NewLine
                                          + ".............."
                                         );

            toolTipButtons.SetToolTip(labelAtmsInNeed,
                                      "ATMs are checked for need of cash " + Environment.NewLine
                                          + "Actions are created for those in need " + Environment.NewLine
                                          + "Actions are authorised and messages are sent to branches and CIT providers" + Environment.NewLine
                                          + "Accounting Entries are created and CIT statement is monitored" + Environment.NewLine
                                          + ".............."
                                         );
        ...
        //  Am.ReadViewAtmsMainForAuthUserAndFillTable(WOperator, WSignedId, WSignRecordNo, AtmNo, FromFunction, WCitId);
           ...
           // Aj.UpdateLatestEjStatusVersion2(WSignedId, WSignRecordNo, WOperator, Am.TableATMsMainSelected);
            ...
            if (checkBox1.Checked == true)
            {
                ...
                toolTipButtons.SetToolTip(button6,
                ...
                toolTipButtons.SetToolTip(button60, "Identify which ATMS are in need based on the last minute picture." + Environment.NewLine
                                             ...
                                             + " 13 : Inform Cash In Transit to Replenish in two days." + Environment.NewLine
                                             ...
                                             + " 16 : ATM appears to have many captured cards and has many Errors" + Environment.NewLine
                                             + " ------------" + Environment.NewLine
                                             + "E-Mails will be sent to appropriate bodies" + Environment.NewLine
                                             + "E-Mail to CIT company to replenished" + Environment.NewLine
                                             + "E-Mail to Branch to do replenishment" + Environment.NewLine
                                             + "E-Mail to Controller for exceptions."
                                             );
                ...
                //NEW JOB CYCLES 
                toolTipButtons.SetToolTip(button50, "Every morning the Manager closes the current Job Cycle " + Environment.NewLine
                                             + "and opens a new one. " + Environment.NewLine
                                             + "From then on the reconciliation can start. "
                                             );
                //NEW JOB CYCLES 
                ...
                toolTipButtons.SetToolTip(button86, "RM Categories in difference are shown." + Environment.NewLine
                                             + "Based on the availability of personnel work(RM Categories) can be allocated." + Environment.NewLine
                                             + "At any time during the day these can be reviewed and reallocation is made when necessary"
                                             );
                ...
                toolTipButtons.SetToolTip(button77,
                                               "This button not Available for this demo" + Environment.NewLine
                                                );
                //Not Available for this demo     
                toolTipButtons.SetToolTip(button78,
                                               "This button not Available for this demo" + Environment.NewLine
                                                );
                //Not Available for this demo     
                toolTipButtons.SetToolTip(button79,
                                               "This button not Available for this demo" + Environment.NewLine
                                                );
                //Not Available for this demo     
                toolTipButtons.SetToolTip(button80,
                                               "This button not Available for this demo" + Environment.NewLine
                                                );
                //Not Available for this demo     
                toolTipButtons.SetToolTip(button81,
                                               "This button not Available for this demo" + Environment.NewLine
                                                );
                //Not Available for this demo     
                toolTipButtons.SetToolTip(button27,
                                               "This button not Available for this demo" + Environment.NewLine
                                                );
                //Not Available for this demo     
                toolTipButtons.SetToolTip(button76,
                                               "This button not Available for this demo" + Environment.NewLine
                                                );
            }
            else
