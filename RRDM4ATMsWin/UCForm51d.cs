  ...
  //      bool Within;
     ...
     //   int tzero = 0;
        ...
        //    WUserOperator = Us.Operator;
            ...
            if (Us.ProcessNo == 8 || Us.ProcessNo == 9) // With 8 and 9 we handle the Atms in NEED 
            {
                label18.Show(); 
                panel8.Show();
                if (Us.ProcessNo == 9) buttonUpdate.Hide();
                OnlyForInMoney = true;
            ...
            if (Us.ProcessNo == 8) // ONLY FOR INVESTIGATION of IN MONEY 
            {
            ...
            if (Us.ProcessNo == 9) // COMES FROM ATM IN NEED - FOR ACTION 
            {
...
// START CALCULATING REPLENISHMENT FIGURES 
     //    
         ...
         //   Rc.GiveMeDataTableReplInfo(WUserOperator, WDTm, WOperator, WPrive, WAtmNo, WReplDate, WCurrentBal, Ac.MatchDatesCateg);
            ...
            if (Rc.NoOfDays == 0 & Us.ProcessNo != 9)
            {
 ...
 private void buttonOverride_Click(object sender, EventArgs e)
 {
     ...
     {
         MessageBox.Show(textBoxOverride.Text, "Please enter a valid number!");
         return;
     }
...
// 
 private void CalculateTotalsForOverrideAndPercentages()
 {
     ...
     catch (Exception ex)
     {
         ...
         MessageBox.Show(textBoxReplaceOne.Text, "Please enter a valid number!" + ex.Message);
         return;
 ...
 private void buttonUpdate_Click(object sender, EventArgs e)
 {
     ...
     if (WTotal > tempInsur) // TOTAL AMOUNT IS LESS THAN INSURED AMOUNT
     {
...
private void button4_Click(object sender, EventArgs e)
{
    ...
    if (Ra.RecordFound == true)
    {
        if (Ra.ActiveRecord == true)
        {
            ...
            Ra.CassetteOneNotes = Tot_51; // Number of notes 
            Ra.CassetteTwoNotes = Tot_52;
            Ra.CassetteThreeNotes = Tot_53;
            Ra.CassetteFourNotes = Tot_54;
    ...
    else
    {
        ...
        MessageBox.Show("Action created.");
