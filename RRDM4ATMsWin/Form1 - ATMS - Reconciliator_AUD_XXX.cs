...
{
    public partial class Form1ATMs_Reconciliator_AUD_XXX : Form
    {
        ...
        public Form1ATMs_Reconciliator_AUD_XXX(string InSignedId, int SignRecordNo, string InSecLevel, string InOperator)
        {
            ...
            labelStep1.Text = "FAB Reconciliation menu ("+ WSignedId+ ")";
