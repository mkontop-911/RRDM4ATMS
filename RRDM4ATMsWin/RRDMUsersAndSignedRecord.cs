...
{
    class RRDMUsersAndSignedRecord
    {
        // Declarations 
      ...
      //  public bool EnableInfo;
        ...
        public void InsertUser(string InUserId)
        {
            ...
            string cmdinsert = "INSERT INTO [UsersTable]"
                ...
                + "[CitId],"
                + "[DateTimeOpen],[email],[MobileNo],[Authoriser],[UserInactive],[UserOnLeave],"
                ...
                try
                {
                    ...
                    using (SqlCommand cmd =
                        new SqlCommand("UPDATE UsersTable SET "
                            ...
                            + "email = @email,MobileNo = @MobileNo,Authoriser = @Authoriser,UserInactive = @UserInactive,"
        ...
        public void InsertSignedActivity(string InUserId)
        {
            ...
            using (SqlConnection conn =
                ...
                try
                {
                  ...
                  //      cmd.Parameters.AddWithValue("@EnableInfo", 1);
        ...
        public void UpdateSignedInTable(int InSignRecordNo)
        {
        ...
        //
        public void UpdateSignedInTableStepLevel(int InSignRecordNo)
        {
