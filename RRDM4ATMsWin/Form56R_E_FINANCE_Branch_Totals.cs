...
{
    public partial class Form56R_E_FINANCE_Branch_Totals : Form
    {
        string WR1;
        string WR2;
        string WR3;
        ...
        public Form56R_E_FINANCE_Branch_Totals(string R1, string R2, string R3, string R4)
        {
            WR1 = R1;
            WR2 = R2;
            WR3 = R3;
        ...
        private void Form56R31ITMX_Load(object sender, EventArgs e)
        {
            //ShowReport();
            ...
            try
            {
                ...
                string RSReportName = RsDir + "/E_FINANCE_Branch_Totals";
        ...
        private ArrayList ReportDefaultPatam()
        {
            ...
            arrLstDefaultParam.Add(CreateReportParameter("InBankIdLogo", WR3));
            arrLstDefaultParam.Add(CreateReportParameter("InUserId", WR4));
