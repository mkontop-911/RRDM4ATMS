...
{
    public partial class UCForm277b_MOB : UserControl
    {
       ...
       // string PRX;
        ...
        public void UCForm277b_MOB_Par(string InSignedId, int SignRecordNo, string InOperator, string InRMCategoryId, int InRMCycle, string InW_Application)
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            WMasterTableName = W_Application + ".[dbo]." + W_Application + "_TPF_TXNS_MASTER";
        ...
        private void buttonAction_Click(object sender, EventArgs e)
        {
            ...
            //if ((WActionId == "91" & Mmob.Origin == "Our Atms" & Mmob.TXNDEST != "1")
            ...
            //    return;
            //}
            //if ((WActionId == "92" & Mmob.Origin == "Our Atms" & Mmob.TXNDEST == "1")
            ...
            //    //RRDMActions_GL Ag = new RRDMActions_GL();
            //    //Ag.ReadActionByActionId_And_Occ(WOperator, WActionId, 1);
            //    if ((Ag.ShortAccID_1 == "20" || Ag.ShortAccID_2 == "20") & (Mmob.TXNSRC == "1" & Mmob.TXNDEST != "1"))
            //    {
            ...
            //    //                     UniqueRecordIdOrigin, Mmob.UniqueRecordId,
            //    //                           WActionId, comboBoxReasonOfAction.Text, Mmob.TransAmount, WOriginWorkFlow, WSesNo);
            ...
            //                               WUniqueRecordIdOrigin, WSeqNo, WActionId, 1,
            //                               WMaker_ReasonOfAction, WOriginWorkFlow);


            //    SelectionCriteria = " WHERE  UniqueRecordId =" + WSeqNo;

            //    Mmob.ReadMatchingTxnsMasterPoolBySelectionCriteria(SelectionCriteria, 1);
            //    if (Mmob.RecordFound == true)
            //    {
            //        Mmob.ActionByUser = true;
            //        Mmob.UserId = WSignedId;
            ...
            //        if (Mmob.Comments != "")
            //            Mmob.Comments = Mmob.Comments + " ," + comboBoxReasonOfAction.Text;
            //        else Mmob.Comments = comboBoxReasonOfAction.Text;

            //        Mmob.UpdateMatchingTxnsMasterPoolATMsFooter(WOperator, WSeqNo, 1);

            //        MessageBox.Show("UnMatched Record with UniqueRecordId : " + WSeqNo.ToString() + Environment.NewLine
        ...
        private void buttonSourceRecords_M_Click(object sender, EventArgs e)
        {
            ...
            //string WTableName = Mn.WTableName_Master_Primary;
            //string WTableName_MATCHED = Mn.WTableName_Master_Matched;

            if (WRMCategoryId == "ETI350" || WRMCategoryId == "QAH350")
            {
                Form78d_AllFiles_BDC_3_MOBILE_TOTALS NForm78d_AllFiles_BDC_3_MOBILE_TOTALS;

                NForm78d_AllFiles_BDC_3_MOBILE_TOTALS = new Form78d_AllFiles_BDC_3_MOBILE_TOTALS(WOperator, WSeqNo, WRMCategoryId, W_Application);
            ...
            else
            {
                ...
                NForm78d_AllFiles_BDC_3_MOBILE = new Form78d_AllFiles_BDC_3_MOBILE(WOperator, WSignedId, WSeqNo, WRMCategoryId, 1, WMasterTableName, W_Application);
