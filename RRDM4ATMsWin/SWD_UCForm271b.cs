...
{
    public partial class SWD_UCForm271b : UserControl
    {
        ...
        public void SWD_UCForm271bPar(string InSignedId, int SignRecordNo, string InOperator, string InAtmNo, int InSesNo, string InCategory, int InRMCycle)
        {
            ...
            Ap.ReadAuthorizationForReplenishmentReconcSpecificForCategoryAndCycle(WCategoryId, WRMCycle, "SWDSession"); //
            ...
            {
                bool Reject = false;
                Ap.GetMessageReconCateg(WCategoryId, WRMCycle, "SWDSession", WAuthoriser, WRequestor, Reject);
        ...
        private void buttonAuthor_Click(object sender, EventArgs e)
        {
            ...
            //Ap.ReadAuthorizationForReplenishmentReconcSpecific(WAtmNo, WSesNo, "SWDSession");
            ...
            if (Ap.RecordFound == true & Ap.Stage < 5 & Ap.OpenRecord == true) // Already exist Repl authorisation 
            {
                MessageBox.Show("This SWDSession Already has authorization record!" + Environment.NewLine
            ...
            string WOrigin = "SWDSession";
           
            int AuthorSeqNumber = 0; // This is used >0 when calling from Authorization management
             
            NForm110 = new Form110(WSignedId, WSignRecordNo, WOperator ,WOrigin, WTranNo, "", 0, AuthorSeqNumber,0,WCategoryId ,WRMCycle, "Normal");
