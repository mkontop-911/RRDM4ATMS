...
{
    public partial class Form291NVMatched_Visa : Form
    {
        /// <summary>
        ...
        public Form291NVMatched_Visa(string InSignedId, int SignRecordNo, string InOperator, string InSubSystem , string InReconcCategoryId, int InReconcCycleNo, int InMode, string InReferenceLike)
        {
        ...
        private void Form291_Load(object sender, EventArgs e)
        {
            ...
            if (WMode == 1)
            {
                ...
                Sec.ReadNVCardRecordsForBothByMode(WOperator, WSignedId, WSubSystem, SearchMode, WReconcCycleNo, ExternalAcc, InternalAcc, "", NullPastDate, "");
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            textBox2.Text = Sec.TxnEntryDate.ToString();
        ...
        public void ShowGrid()
        {
            ...
            dataGridView1.Columns[3].Width = 80; //MatchedType
            ...
            dataGridView1.Columns[8].Width = 90; // EntryDate
            dataGridView1.Columns[8].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            dataGridView1.Columns[9].Width = 40; // DR/CR
            dataGridView1.Columns[9].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            dataGridView1.Columns[10].Width = 100; // Amt
            ...
            dataGridView1.Columns[11].Width = 50; // Ccy
            ...
            dataGridView1.Columns[15].Width = 95; // CcyRate
            ...
            dataGridView1.Columns[16].Width = 95; // GLAccount
