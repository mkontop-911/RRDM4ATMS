...
{
    public partial class Form271FastTrack_OLD : Form
    {
        ...
        public Form271FastTrack_OLD(string InSignedId, int InSignRecordNo, string InOperator, string InReconcCategory, int InWRMCycleNo, string InAtmNo)
        {
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            ...
            //conn.Open(); 
                ...
                while (K <= (dataGridView1.Rows.Count - 1))
                {
                    ...
                    if (radioButtonForceMatching.Checked == true) WActionId = "04";

                    if (WSelect == true)
                    {
                        SelectionCriteria = " WHERE  UniqueRecordId =" + WUniqueRecordId;
                    // Mpa.ReadMatchingTxnsMasterPoolBySelectionCriteria_2(SelectionCriteria, 1, conn);
                    ...
                    if ((WActionId == "04") & Mpa.ActionType == "00")
                        ...
                        //if (radioButtonMoveToPool.Checked == true & Mpa.ActionType == "00")
                        //{
                        ...
                        //    // UPDATE RECORDS IN TABLES AS ACTIVE
                        //    //
