...
{
    public partial class UCForm281cXXX : UserControl
    {
        ...
        public void UCForm281cXXXPar(string InSignedId, int InSignRecordNo, string InOperator, string InCategory, int InCategMathingSession)
        {
            ...
            if (WCategory == "EWB311")
            {
                ...
                Rs.ReadMatchingCategoriesSessionsByRunningJobNo(WOperator, WCategMatchingSession);


                WProcess = 4; // Include corrected errors 
                Rs.ReadAllErrorsFromCategSessionGL
        ...
        public void SetScreen()
        {
            ...
            if (WCategory == "EWB102")
            {
                ...
                Rs.ReadAllErrorsFromCategSessionForAllAtmsWithErrors
                ...
                textBox8.Text = Rs.GlYesterdaysBalance.ToString("#,##0.00");
                decimal WRRDMJournalBalCateg = Rs.GlTodaysBalance; 
                ...
                if ((WRRDMJournalBalCateg - Rs.BanksClosedBalAdjWithErrors) == 0)
                {
                    ...
                    if (Er.NumOfErrors == Er.ErrUnderAction + Er.ErrDisputeAction)
                    {
                        UpdateReconcStatus(1);
                    }
                    else
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (WCategory == Er.CategoryId)
            {
                ...
                Dt.ReadDisputeTranByMaskRecordId(Er.MaskRecordId);
            ...
            else
            {
                ...
                //textBox6.Text = Rs.GlTodaysBalance.ToString("#,##0.00");
                textBoxDiffForAtm.Text = (WOpenAndMatched - Rs.BanksClosedBalAdjWithErrors).ToString("#,##0.00");
...
// Move to Dispute 
        ...
        private void buttonCreateError_Click(object sender, EventArgs e)
        {
            ...
            if (decimal.TryParse(textBoxDiffForAtm.Text, out AmountForSuspense))
            {
                int MaskRecordId = 0;
                int SesNo = 0;
                NForm14 = new Form14a(WSignedId, WCategory, WCategMatchingSession, MaskRecordId, Er.AtmNo, SesNo, 
                                                                                         WOperator, AmountForSuspense, WCurrNm);
                NForm14.FormClosed += NForm14_FormClosed;
                NForm14.Show();
            }
            else
            {
                MessageBox.Show("NO AMOUNT FOR SUSPENSE", "Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
