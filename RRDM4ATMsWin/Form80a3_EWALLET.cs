...
{
    public partial class Form80a3_EWALLET : Form
    {
        ...
        string WRMCategory;
        string WhatBankId;
        public Form80a3_EWALLET(string InSignedId, int SignRecordNo, string InOperator, 
                                                      string InFunction, string InRMCategory, string InWhatBankId)
        {
            ...
            if (Usi.RecordFound == true)
            {
                ...
                if (W_Application == "e_MOBILE")
                {
                    ...
                    labelStep1.Text = "Categories Menu-Mobile_" + W_Application;
                }
                else
                {
                    W_Application = "ATMs";
                    labelStep1.Text = "Categories Menu-_" + W_Application;
                }
            }
        ...
        private void buttonNext_Click(object sender, EventArgs e)
        {
            ...
            if (WFunction == "View" & WOperator != "ITMX")
            {
                ...
                if (W_Application == "ETISALAT" || W_Application == "QAHERA" || W_Application == "EQATE")
                {
                    // e_MOBILE
