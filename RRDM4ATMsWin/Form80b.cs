...
namespace RRDM4ATMsWin
{
    public partial class Form80b : Form
    {
        ...
        public Form80b(string InSignedId, int InSignRecordNo, string InOperator, DateTime InDateTimeA, DateTime InDateTimeB, string InAtmNo, string InCategoryId, int InRMCycleNo,
                                                 ...
                                                 string InFunction, string InIncludeNotMatchedYet, int InReplCycle)
        {
            ...
            //    buttonBT_TXN_BAL_V2.Show();
            //}
            //else
            //{
            //    buttonBT_TXN_BAL.Hide();
            //    buttonBT_TXN_BAL_V2.Hide();
            //}
        ...
        private void Form80b_Load(object sender, EventArgs e)
        {
            ...
            if (radioButtonAllTxns.Checked == true) // All transactions
            {
                ...
                WSortCriteria = " ORDER BY TransDate ASC";
...
// Show The TXN BALANCE
        private void buttonBT_TXN_BAL_Click(object sender, EventArgs e)
        {
           // string WAtmNo = "EJ017002";
            int TempSeqNo = Mpa.OriginalRecordId;

            //Form51_TXN_Cassettes_BAL Cb = new Form51_TXN_Cassettes_BAL();
            Form51_TXN_Cassettes_BAL NForm51_TXN_Cassettes_BAL;
            NForm51_TXN_Cassettes_BAL = new Form51_TXN_Cassettes_BAL(WOperator, WSignedId, WAtmNo, TempSeqNo);
