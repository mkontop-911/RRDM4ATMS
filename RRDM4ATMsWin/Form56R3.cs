...
{
    public partial class Form56R3 : Form
    {
        string WR1;
        string WR2;
        string WR3;
      ...
      //  string WR13;
        ...
        public Form56R3(string R1, string R2, string R3, string R4, string R5, string R6,
                        string R7, string R8, string R9, string R10, string R11,
                        string R12, string R13, string R14, string R21, string R15, string R16)
        {
            WR1 = R1;
            WR2 = R2;
            WR3 = R3;
        ...
        private void Form56R3_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string RSReportName = RsDir + "/TransactionsToBePosted";
        ...
        private ArrayList ReportDefaultPatam()
        {
            ...
            arrLstDefaultParam.Add(CreateReportParameter("AtmNo", WR4));
            ...
            arrLstDefaultParam.Add(CreateReportParameter("ErrorNo", WR10));
            arrLstDefaultParam.Add(CreateReportParameter("ErrDescr", WR11));
