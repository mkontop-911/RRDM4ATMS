...
{
    public partial class Form24_ByDates : Form
    {
        ...
        public Form24_ByDates(string InSignedId, int InSignRecordNo, string InOperator, string InAtmNo, int InSesNo , DateTime InDateFrom , DateTime InDateTo )
        {
        ...
        private void Form24_Load(object sender, EventArgs e)
        {
            ...
            Ea.ReadErrorsAndFillTableByDates(WOperator, WSignedId, WAtmNo, WDateFrom, WDateTo); 
