...
{
    public partial class Form174 : Form
    {
  ...
  //      bool RecordFound;
        ...
        decimal WBalGel; decimal WABalGel;// int WBatchNo;
        //  int WFirstTraceNo;// int WLastTraceNo; //int WHFirstTraceNo; 
        // int WHLastTraceNo;
    //    int WStatus;
    ...
    //    int SessionsInDiff;
     ...
     //   string WUserOperator; 
        ...
        public Form174(string InSignedId, int SignRecordNo, string InOperator, string InAtmNo, int InSesNo, int ReconcBalanceNo)
        {
            ...
            WAtmNo = InAtmNo;
            WSesNo = InSesNo;
            WReconcile = ReconcBalanceNo; // 1 = firsts set of OF BALANCE 2 = second etc ... 
            //    if (CurrType==1) Primary = true;
            ...
            label34.Text = DateTime.Now.ToShortDateString();

            WProcess = 5; // INCLUDE IN BALANCES ANY CORRECTED ERRORS 
            ...
            textBoxMsgBoard.Text = "CHOOSE ERROR NO FROM TABLE AND MAKE DECISION";
            ...
            if (WReconcile == 1)
            {
                ...
                //         textBox7.Text = Na.Balances1.HostBal.ToString();
                textBox33.Text = Na.Balances1.HostBalAdj.ToString("#,##0.00");

                textBox8.Text = Na.BalDiff1.Machine.ToString("#,##0.00");
                //textBox9.Text = Na.BalDiff1.ReplToRepl.ToString();
                //           textBox10.Text = Na.BalDiff1.Host.ToString();
                textBox34.Text = Na.BalDiff1.HostAdj.ToString("#,##0.00");

          //      WCurrCd = Na.Balances1.CurrCd;
                ...
                WBalGel = Na.Balances1.HostBal;
                WABalGel = Na.Balances1.HostBalAdj;

            }

            // REQUEST TO RECONCILE SECOND SET OF BALANCES

            if (WReconcile == 2)
            {
                label21.Text = Na.Balances2.CurrNm;

                textBox3.Text = Na.Balances2.CountedBal.ToString("#,##0.00");
                textBox5.Text = Na.Balances2.MachineBal.ToString("#,##0.00");
                //textBox6.Text = Na.Balances2.ReplToRepl.ToString();
                //     textBox7.Text = Na.Balances2.HostBal.ToString();
                textBox33.Text = Na.Balances2.HostBalAdj.ToString("#,##0.00");

                textBox8.Text = Na.BalDiff2.Machine.ToString("#,##0.00");
                //textBox9.Text = Na.BalDiff2.ReplToRepl.ToString();
                //    textBox10.Text = Na.BalDiff2.Host.ToString();
                textBox34.Text = Na.BalDiff2.HostAdj.ToString("#,##0.00");

          //      WCurrCd = Na.Balances2.CurrCd;
                WCurrNm = Na.Balances2.CurrNm;
                WCountedBal = Na.Balances2.CountedBal;
                WAtmBalance = Na.Balances2.MachineBal;
                WRepToReplBal = Na.Balances2.ReplToRepl;
                WBalGel = Na.Balances2.HostBal;
                WABalGel = Na.Balances2.HostBalAdj;
            }
            // REQUEST TO RECONCILE THIRD SET OF BALANCES

            if (WReconcile == 3)
            {
                label21.Text = Na.Balances3.CurrNm;

                textBox3.Text = Na.Balances3.CountedBal.ToString("#,##0.00");
                textBox5.Text = Na.Balances3.MachineBal.ToString("#,##0.00");
                //textBox6.Text = Na.Balances3.ReplToRepl.ToString();
                //    textBox7.Text = Na.Balances3.HostBal.ToString();
                textBox33.Text = Na.Balances3.HostBalAdj.ToString("#,##0.00");

                textBox8.Text = Na.BalDiff3.Machine.ToString("#,##0.00");
                //textBox9.Text = Na.BalDiff3.ReplToRepl.ToString();
                //     textBox10.Text = Na.BalDiff3.Host.ToString();
                textBox34.Text = Na.BalDiff3.HostAdj.ToString("#,##0.00");

          //      WCurrCd = Na.Balances3.CurrCd;
                WCurrNm = Na.Balances3.CurrNm;
                WCountedBal = Na.Balances3.CountedBal;
                WAtmBalance = Na.Balances3.MachineBal;
                WRepToReplBal = Na.Balances3.ReplToRepl;
                WBalGel = Na.Balances3.HostBal;
                WABalGel = Na.Balances3.HostBalAdj;
            }
            // REQUEST TO RECONCILE FORTH SET OF BALANCES

            if (WReconcile == 4)
            {
                label21.Text = Na.Balances4.CurrNm;

                textBox3.Text = Na.Balances4.CountedBal.ToString("#,##0.00");
                textBox5.Text = Na.Balances4.MachineBal.ToString("#,##0.00");
                //textBox6.Text = Na.Balances4.ReplToRepl.ToString();
                //   textBox7.Text = Na.Balances4.HostBal.ToString();
                textBox33.Text = Na.Balances4.HostBalAdj.ToString("#,##0.00");

                textBox8.Text = Na.BalDiff4.Machine.ToString("#,##0.00");
                //textBox9.Text = Na.BalDiff4.ReplToRepl.ToString();
                //     textBox10.Text = Na.BalDiff4.Host.ToString();
                textBox34.Text = Na.BalDiff4.HostAdj.ToString("#,##0.00");

          //      WCurrCd = Na.Balances4.CurrCd;
                WCurrNm = Na.Balances4.CurrNm;
                WCountedBal = Na.Balances4.CountedBal;
                WAtmBalance = Na.Balances4.MachineBal;
                WRepToReplBal = Na.Balances4.ReplToRepl;
                WBalGel = Na.Balances4.HostBal;
                WABalGel = Na.Balances4.HostBalAdj;
            }
        ...
        private void Form174_Load(object sender, EventArgs e)
        {
            ...
            this.errorsTableTableAdapter.Fill(this.aTMSDataSet6.ErrorsTable);
...
// Dissable buttons for view only 
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (WAtmNo == Pa.AtmNo)
            {
                ...
                if (Pa.UnderAction == true)
                {
                    ...
                    textBoxMsgBoard.Text = "Action taken. Undo if you have changed your mind.";
                }
                else
                {
                    ...
                    label5.Text = "Action Not Taken"; // DONE
                    pictureBox3.Show(); // Take Action
                    buttonApplyAction.Show();
                    buttonUndoAction.Hide();
                    textBoxMsgBoard.Text = "Study error and decide action.";
                }
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            if (radioSystemSuggest.Checked || radioButtonMoveToDispute.Checked)
            {
                if (Pa.UnderAction == true)
                {
                ...
                //textBox17.Text = WRepToReplBal.ToString();
                //   textBox16.Text = WBalGel.ToString();
                textBox36.Text = WABalGel.ToString("#,##0.00");

                textBox15.Text = (WCountedBal - WAtmBalance).ToString("#,##0.00");
                //textBox14.Text = (WCountedBal - WRepToReplBal).ToString();
                //   textBox13.Text = (WCountedBal - WBalGel).ToString();
                textBox35.Text = (WCountedBal - WABalGel).ToString("#,##0.00");
                ...
                if ((WCountedBal - WAtmBalance) == 0 & (WCountedBal - WRepToReplBal) == 0 & (WCountedBal - WABalGel) == 0)
                {
                    ...
                    if (Na.DiffAtAtmLevel == false & Na.DiffAtHostLevel == false & Na.DiffWithErrors == false)
                    {
                        ...
                        textBoxMsgBoard.Text = " SEE REFRESHED BALANCES. THEY DO RECONCILE. GO TO RECONCILIATON FORM. ";

                    }
                    else  // There is other tan this difference  
                    {
                        textBoxMsgBoard.Text = " YOU HAVE MORE ITEMS TO RECONCILE. GO TO RECONCILIATON FORM.";
                ...
                {
                    textBoxMsgBoard.Text = " SEE REFRESHED BALANCES. THEY DO NOT RECONCILE - YOU HAVE TO TAKE ADDITIONAL ACTION ";
            ...
            if (radioButtonPostpone.Checked)
            {
                ...
                textBoxMsgBoard.Text = " YOU have decided that for this error a manual action will be taken ";
        ...
        private void button7_Click_1(object sender, EventArgs e)
        {
            ...
            if (Pa.UnderAction == true & Pa.ManualAct == false)
            {
                ...
                if ((WCountedBal - WAtmBalance) == 0 & (WCountedBal - WRepToReplBal) == 0 & (WCountedBal - WABalGel) == 0)
                {
                    ...
                    textBoxMsgBoard.Text = " BALANCES RECONCILE - YOU CAN MOVE TO FINISH ";

                }
                else
                {
                    textBoxMsgBoard.Text = " BALANCES DO NOT RECONCILE - TAKE ACTIONS TO CORRECT SITUATION ";
        ...
        {
            Form174_Load(this, new EventArgs());
        }
