...
{
    public partial class Form56R55_5 : Form
    {
        string WR1;
        string WR2;
        string WR3;
        ...
        public Form56R55_5(string R1, string R2, string R3, string R4, string R5)
        {
            WR1 = R1;
            WR2 = R2;
            WR3 = R3;
        ...
        private void Form56R34ITMX_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string RSReportName = RsDir + "/ATMSView55_2_Auditors_New";
