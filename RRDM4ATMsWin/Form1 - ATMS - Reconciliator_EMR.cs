...
{
    public partial class Form1ATMs_Reconciliator_EMR : Form
    {
        ...
        public Form1ATMs_Reconciliator_EMR(string InSignedId, int SignRecordNo, string InSecLevel, string InOperator)
        {
...
// Compined Reconciliation Report 
