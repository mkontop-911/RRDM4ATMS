...
{
    public partial class Form56R64NOSTRO : Form
    {
        string WR1;
        string WR2;
        string WR3;
        ...
        public Form56R64NOSTRO(string R1, string R2, string R3, string R4, string R5, string R6, string R7)
        {
            WR1 = R1;
            WR2 = R2;
            WR3 = R3;
        ...
        private void Form56R34ITMX_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string RSReportName = RsDir + "/NOSTROView64";
        ...
        private ArrayList ReportDefaultPatam()
        {
            ...
            arrLstDefaultParam.Add(CreateReportParameter("FromDt", WR6));
            arrLstDefaultParam.Add(CreateReportParameter("ToDt", WR7));
