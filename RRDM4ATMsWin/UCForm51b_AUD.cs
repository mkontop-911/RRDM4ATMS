...
{
    public partial class UCForm51b_AUD : UserControl
    {
       ...
       // Form24 NForm24; // Show the errors 
        ...
        int Cassettes_1_DiffCas;
        int Cassettes_2_DiffCas;
        int Cassettes_3_DiffCas;
        int Cassettes_4_DiffCas;
        ...
        public void UCForm51bPar_AUD(string InSignedId, int InSignRecordNo, string InOperator, string InAtmNo, int InSesNo)
        {
        ...
        public void SetScreen()
        {
            ...
            textBox11.Text = (Na.Cassettes_1.RemNotes+ Na.Cassettes_1.RejNotes).ToString(); // Add together Cassettes and Rejected 
            label11.Text = "Type 1- " + temp.ToString() + " " + Na.Cassettes_1.CurName;
            textBox22.Text = Na.Cassettes_1.RejNotes.ToString(); // Show just for information 
            ...
            textBox13.Text = (Na.Cassettes_2.RemNotes+ Na.Cassettes_2.RejNotes).ToString();
            ...
            textBox15.Text = (Na.Cassettes_3.RemNotes+ Na.Cassettes_3.RejNotes).ToString();
            ...
            textBox17.Text = (Na.Cassettes_4.RemNotes+ Na.Cassettes_4.RejNotes).ToString();
            ...
            Cassettes_1_DiffCas = Na.Cassettes_1.CasCount - (Na.Cassettes_1.RemNotes + Na.Cassettes_1.RejNotes);
            textBox12.Text = Cassettes_1_DiffCas.ToString();
            textBox21.Text = (Na.Cassettes_1.FaceValue * Cassettes_1_DiffCas).ToString("#,##0.00");
            ...
            Cassettes_2_DiffCas = Na.Cassettes_2.CasCount - (Na.Cassettes_2.RemNotes + Na.Cassettes_2.RejNotes);
            textBox14.Text = Cassettes_2_DiffCas.ToString();
            textBox45.Text = (Na.Cassettes_2.FaceValue * Cassettes_2_DiffCas).ToString("#,##0.00");
            ...
            Cassettes_3_DiffCas = Na.Cassettes_3.CasCount - (Na.Cassettes_3.RemNotes + Na.Cassettes_3.RejNotes);
            textBox16.Text = Cassettes_3_DiffCas.ToString();
            textBox46.Text = (Na.Cassettes_3.FaceValue * Cassettes_3_DiffCas).ToString("#,##0.00");
            ...
            Cassettes_4_DiffCas = Na.Cassettes_4.CasCount - (Na.Cassettes_4.RemNotes + Na.Cassettes_4.RejNotes);
            textBox18.Text = Cassettes_4_DiffCas.ToString();
            textBox47.Text = (Na.Cassettes_4.FaceValue * Cassettes_4_DiffCas).ToString("#,##0.00");
        ...
        private void buttonUseAtmsFigures_Click(object sender, EventArgs e)
        {
            ...
            // SHOW 
            // Cassette 1
            textBox1.Text = (Na.Cassettes_1.RemNotes+ Na.Cassettes_1.RejNotes).ToString(); // Rem Notes in Cassettes + Rejected 
            //textBox5.Text = Na.Cassettes_1.RejNotes.ToString();

            // Cassette 2
            textBox2.Text = (Na.Cassettes_2.RemNotes+ Na.Cassettes_2.RejNotes).ToString();
            //textBox6.Text = Na.Cassettes_2.RejNotes.ToString();

            // Cassette 3
            textBox3.Text = (Na.Cassettes_3.RemNotes+ Na.Cassettes_3.RejNotes).ToString();
            //textBox7.Text = Na.Cassettes_3.RejNotes.ToString();

            // Cassette 4
            textBox4.Text = (Na.Cassettes_4.RemNotes+ Na.Cassettes_4.RejNotes).ToString();
        ...
        private void buttonUpdateInput_Click(object sender, EventArgs e)
        {
            ...
            // Show differences in Notes  
            //Na.Cassettes_1.CasCount - (Na.Cassettes_1.RemNotes+Na.Cassettes_1.RejNotes)
            Cassettes_1_DiffCas = Na.Cassettes_1.CasCount - (Na.Cassettes_1.RemNotes + Na.Cassettes_1.RejNotes); 

            textBox12.Text = Cassettes_1_DiffCas.ToString();
            textBox21.Text = (Na.Cassettes_1.FaceValue * Cassettes_1_DiffCas).ToString("#,##0.00");
            //textBox23.Text = Na.Cassettes_1.DiffRej.ToString();
            //textBox41.Text = (Na.Cassettes_1.FaceValue * Na.Cassettes_1.RejNotes).ToString("#,##0.00"); // Show just the value 
            ...
            if (Cassettes_1_DiffCas == 0  &
                Cassettes_2_DiffCas == 0  &
                Cassettes_3_DiffCas == 0  &
                Cassettes_4_DiffCas == 0 
                )
            {
                if (Na.Balances1.PresenterValue > 0)
                {
