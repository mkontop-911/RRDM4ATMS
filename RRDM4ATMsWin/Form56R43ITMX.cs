...
{
    public partial class Form56R43ITMX : Form
    {
        string WR1;
        string WR2;
        string WR3;
        ...
        public Form56R43ITMX(string R1, string R2, string R3,string R4, string R5)
        {
            WR1 = R1;
            WR2 = R2;
            WR3 = R3;
        ...
        private void Form56R43ITMX_Load(object sender, EventArgs e)
        {
            //ShowReport();
            ...
            try
            {
                ...
                string RSReportName = RsDir + "/ITMXReport43";
        ...
        private ArrayList ReportDefaultPatam()
        {
            ...
            arrLstDefaultParam.Add(CreateReportParameter("VersionId", WR1));
