...
@SET Line0=ATMs                     Atms_Journals_Txns     ALPHA_CY
@SET Line1=Banking_System           Flexcube               ALPHA_CY
@SET Line2=Bank's_Switch            Switch_IST_Txns        ALPHA_CY
@SET Line3=National_Switch          Egypt_123_NET          ALPHA_CY
@SET Line4=Visa_International       VISA_CARD              ALPHA_CY
@SET Line5=MasterCard_Internatinal  MASTER_CARD            ALPHA_CY
@SET Line9=RRDM Agent                                      ALPHA_CY

@SET Orig0=ATMs
@SET Src0=Atms_Journals_Txns
@SET Parm0=ATMs Atms_Journals_Txns ALPHA_CY

@SET Orig1=Banking_System
@SET Src1=Flexcube
@SET Parm1=Banking_System Flexcube ALPHA_CY

@SET Orig2=Bank's_Switch
@SET Src2=Bank's_Switch
@SET Parm2=Bank's_Switch Switch_IST_Txns ALPHA_CY

@SET Orig3=National_Switch
@SET Src3=Egypt_123_NET
@SET Parm3=National_Switch Egypt_123_NET ALPHA_CY

@SET Orig4=Visa_International
@SET Src4=VISA_CARD
@SET Parm4=Visa_International VISA_CARD ALPHA_CY

@SET Orig5=MasterCard_Internatinal
@SET Src5=MASTER_CARD
@SET Parm5=MasterCard_Internatinal MASTER_CARD ALPHA_CY
...
@sc description "RRDM Agent" "RRDM Agent service for Operator '%Parm%'"
@sc start "RRDM Agent"
@timeout 5 
@@sc qc "RRDM Agent"
...
@sc description "RRDM RFM %Orig%" "RRDM Reconciliation File Monitor for '%Src%' source files of type '%Orig%'"
