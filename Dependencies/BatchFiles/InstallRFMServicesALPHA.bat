...
:ATMs_WCR01
@echo sc create "RRDM RFM %OrigATMs%" binpath= "C:\RRDM\RRDMExec\RRDMRFMService.exe %OrigATMs% %ATMs% ALPHA_CY" %options%
sc create "RRDM RFM %OrigATMs%" binpath= "C:\RRDM\RRDMExec\RRDMRFMService.exe %OrigATMs% %ATMs% ALPHA_CY" %options%
...
:T24_T2401
sc create "RRDM RFM %OrigT24%" binpath= "C:\RRDM\RRDMExec\RRDMRFMService.exe %OrigT24% %T24% ALPHA_CY" %options%
...
:Base24_FTOD-TLF
sc create "RRDM RFM %OrigBase24%" binpath= "C:\RRDM\RRDMExec\RRDMRFMService.exe %OrigBase24% %Base24% ALPHA_CY" %options%
