...
@SET Line0=ATMs                     Atms_Journals_Txns     AUDBEGCA
@SET Line1=Banking_System           Flexcube               AUDBEGCA
@SET Line2=Bank's_Switch            Switch_IST_Txns        AUDBEGCA
@SET Line3=National_Switch          Egypt_123_NET          AUDBEGCA
@SET Line4=Visa_International       VISA_CARD              AUDBEGCA
@SET Line5=MasterCard_Internatinal  MASTER_CARD            AUDBEGCA
@SET Line9=RRDM Agent                                      AUDBEGCA

@SET Orig0=ATMs
@SET Src0=Atms_Journals_Txns
@SET Parm0=ATMs Atms_Journals_Txns AUDBEGCA

@SET Orig1=Banking_System
@SET Src1=Flexcube
@SET Parm1=Banking_System Flexcube AUDBEGCA

@SET Orig2=Bank's_Switch
@SET Src2=Bank's_Switch
@SET Parm2=Bank's_Switch Switch_IST_Txns AUDBEGCA

@SET Orig3=National_Switch
@SET Src3=Egypt_123_NET
@SET Parm3=National_Switch Egypt_123_NET AUDBEGCA

@SET Orig4=Visa_International
@SET Src4=VISA_CARD
@SET Parm4=Visa_International VISA_CARD AUDBEGCA

@SET Orig5=MasterCard_Internatinal
@SET Src5=MASTER_CARD
@SET Parm5=MasterCard_Internatinal MASTER_CARD AUDBEGCA
