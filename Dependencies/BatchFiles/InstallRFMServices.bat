...
:ATMs_WCR01
@echo sc create "RRDM RFM %OrigATMs%" binpath= "C:\RRDM\RRDMExec\RRDMRFMService.exe %OrigATMs% %ATMs% ETHNCY2N" %options%
sc create "RRDM RFM %OrigATMs%" binpath= "C:\RRDM\RRDMExec\RRDMRFMService.exe %OrigATMs% %ATMs% ETHNCY2N" %options%
