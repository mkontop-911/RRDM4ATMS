...
@echo   1 - Truncate NBGT2401 
@echo   2 - Truncate NBGBase24TLF 
@echo   3 - Start RRDMRFM for T24 T2401
@echo   4 - Start RRDMRFM for Base24 FTOD-TLF
@echo   5 - Start RRDMRFM for ATMs WCR01
@echo   6 - Select a T24 file for import
@echo   7 - Select a Base24 file for import
@echo   8 - Select an eJournal file for import
@echo   X - eXit
...
@echo.
@echo StartT2401
START /min RRDMRFM.exe "T24" "T2401" "ETHNCY2N"
@goto :BackToMainMenu
...
START /min RRDMRFM.exe "Base24" "FTOD-TLF" "ETHNCY2N"
@goto :BackToMainMenu
...
@echo.
@echo StartATMsWCR01
START /min RRDMRFM.exe "ATMs" "WCR01" "ETHNCY2N"
@goto :BackToMainMenu
