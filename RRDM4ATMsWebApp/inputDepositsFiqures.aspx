<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inputDepositsFiqures.aspx.cs" Inherits="inputDepositsFiqures" %>
...
<html>
    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-7">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><asp:Label ID="Label9" runat="server" Text="Input Deposits Figures"></asp:Label></li>
        ...
        <!-- Content -->
        <div class="container deposits-fiqures" style="margin-top:20px">
            <div class="row deposits-fiqures-box">

                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><asp:Label ID="Label12" runat="server" Text="Cahs Deposits - EUR"></asp:Label></h3>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive no-border">
                                <table class="table no-border">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><asp:Label ID="Label21" runat="server" Text="Number of Transactions"></asp:Label></td>
                                        ...
                                        <tr>
                                            <td><asp:Label ID="Label22" runat="server" Text="Number of Notes"></asp:Label></td>
                                        ...
                                        <tr>
                                            <td><asp:Label ID="Label23" runat="server" Text="Deposted Amount"></asp:Label></td>
                                        ...
                                        <tr>
                                            <td><asp:Label ID="Label24" runat="server" Text="Suspect Notes"></asp:Label></td>
                                        ...
                                        <tr>
                                            <td><asp:Label ID="Label41" runat="server" Text="Suspect Amount"></asp:Label></td>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><asp:Label ID="Label13" runat="server" Text="Cheques - EUR"></asp:Label></h3>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive no-border">
                                <table class="table no-border">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><asp:Label ID="Label36" runat="server" Text="Number of Transuctions"></asp:Label></td>
                                        ...
                                        <tr>
                                            <td><asp:Label ID="Label16" runat="server" Text="Number of Cheques"></asp:Label></td>
                                            <td><asp:TextBox ID="TextBox34" CssClass="form-control" runat="server"></asp:TextBox></td>
                                            <td><asp:TextBox ID="TextBox35" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox></td>
                                            <td><asp:TextBox ID="TextBox36" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td><asp:Label ID="Label42" runat="server" Text="Cheque AMount"></asp:Label></td>
                                            <td><asp:TextBox ID="TextBox37" CssClass="form-control" runat="server"></asp:TextBox></td>
                                            <td><asp:TextBox ID="TextBox38" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox></td>
                                            <td><asp:TextBox ID="TextBox39" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><asp:Label ID="Label14" runat="server" Text="Envelopes Deposited - EUR"></asp:Label></h3>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive no-border">
                                <table class="table no-border">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><asp:Label ID="Label28" runat="server" Text="Number of Envelopes"></asp:Label></td>
                                        ...
                                        <tr>
                                            <td><asp:Label ID="Label29" runat="server" Text="Deposted Amount"></asp:Label></td>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><asp:Label ID="Label15" runat="server" Text="Money Totals - EUR"></asp:Label></h3>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive no-border">
                                <table class="table no-border">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><asp:Label ID="Label39" runat="server" Text="Deposted-BNA"></asp:Label></td>
                                        ...
                                        <tr>
                                            <td><asp:Label ID="Label30" runat="server" Text="Envelopes"></asp:Label></td>
                                        ...
                                        <tr>
                                            <td><asp:Label ID="Label31" runat="server" Text="Cheques"></asp:Label></td>
                ...
                <div class="col-md-12">
                    <div class="pull-right form-group">
                        <asp:Button ID="Button5" CssClass="btn btn-white" runat="server" Text="Show Trans"></asp:Button>
        ...
        <footer class="footer">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h6><asp:Label ID="Label44" runat="server" Text="Verify Figures, Changes them if needed and press update"></asp:Label></h6>
                </div>
                <div class="col-sm-6">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('.deposits-fiqures-box').each(function () {
                    var highestBox = 0;
