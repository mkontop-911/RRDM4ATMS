...
namespace RRDM4ATMs
{
    public class RRDMDisputeTrasactionClass
    {
        ...
        public void ReadDisputeTranForInPool(int InMaskRecordId)
        {
            RecordFound = false;
            ErrorFound = false;
            ErrorOutput = ""; 
 ...
 */
        ...
        public void InsertDisputeTran(int InDisputeNo)
        {
            ...
            string cmdinsert = "INSERT INTO [dbo].[DisputesTransTable]"
                + " ([MaskRecordId],[DisputeNumber], [DispDtTm],[BankId],[DbTranNo],[Origin],"
