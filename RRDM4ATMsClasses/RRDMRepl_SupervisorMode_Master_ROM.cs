...
namespace RRDM4ATMs
{
    public class RRDMRepl_SupervisorMode_Master_ROM : Logger
    {
        public RRDMRepl_SupervisorMode_Master_ROM() : base() { }
        ...
        RRDMRepl_SupervisorMode_Details_ROM SM = new RRDMRepl_SupervisorMode_Details_ROM();
