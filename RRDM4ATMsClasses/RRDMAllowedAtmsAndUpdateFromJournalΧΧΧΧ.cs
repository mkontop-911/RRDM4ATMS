...
namespace RRDM4ATMs
{
    public class RRDMAllowedAtmsAndUpdateFromJournalΧΧΧΧ
    {
    ...
    //    bool WPrive;
        ...
        public void CreateTableOfAccess(string InSignedId, int InSignRecordNo, string InOperator, string InFunction)
        {
            ...
            Usi.ReadSignedActivityByKey(InSignRecordNo); // Read Security Level

            if (Usi.SecLevel == "03") // 2: Initialise Data Grid , // 1: Update Data Grid with AUthorised User 
            {
