...
namespace RRDM4ATMs
{
    public class RRDMRepl_SupervisorMode_Details_ROM : Logger
    {
        public RRDMRepl_SupervisorMode_Details_ROM() : base() { }
        // Variables
        public int SeqNo;
 ...
 + " ,[ATM_cassette1]= ISNULL([ATM_cassette1],0) "
   ...
   + "     ,[ATM_Rejected3]= ISNULL([ATM_Rejected3],0) "
    ...
    //  + "      ,[ATM_Remaining5]= ISNULL([ATM_Remaining5],0) "
      ...
      + "    ,[ATM_Remaining1]= [ATM_cassette1] + [ATM_Rejected1] "
     + "    ,[ATM_Remaining2]= [ATM_cassette2] + [ATM_Rejected2] "
      + "    ,[ATM_Remaining3]= [ATM_cassette3] + [ATM_Rejected3] "
       + "    ,[ATM_Remaining4]= [ATM_cassette4] + [ATM_Rejected4] "
      + "      ,[ATM_Remaining5]= ISNULL([ATM_Remaining5],0) "
     ...
     //  + "     ,[ATM_total5]= ISNULL([ATM_total5],0) "
        ...
        + "   ,[ATM_total1]= ATM_cassette1 + ATM_Rejected1  + ATM_Dispensed1 "
      + "   ,[ATM_total2]= ATM_cassette2 + ATM_Rejected2  + ATM_Dispensed2 "
      + "    ,[ATM_total3]= ATM_cassette3 + ATM_Rejected3  + ATM_Dispensed3 "
      + "     ,[ATM_total4]= ATM_cassette4 + ATM_Rejected4  + ATM_Dispensed4 "
       + "     ,[ATM_total5]= ISNULL([ATM_total5],0) "
