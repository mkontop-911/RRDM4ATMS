...
namespace RRDM4ATMs
{
    public class RRDMRepl_SupervisorMode_Master_ALPHA : Logger
    {
        public RRDMRepl_SupervisorMode_Master_ALPHA() : base() { }
                                                             ...
                                                             int InMode, string InFrom)
        {
            ...
            try
            {
                ...
                if ((WMode == 3 || WMode == 2 || WMode == 4) & SM_Management == "YES")
                {
                    ...
                    //{
                    //    // ALPHA has ADDITIONAL CASH 
                    //    SM.Update_SM_Record_WithAddedCash_ALPHA();
                    //}
                    ...
                    while (I <= (SM.DataTable_SM.Rows.Count - 1))
                    {
                        ...
                        if (SM.AdditionalCash == "N") // THIS IS NOT FOR ADDING CASH ONLY
                        {
                            ...
                            //SM.Update_SM_Deposit_analysis_ALPHA(WAtmNo, WSeqNo);
                            // Replenishment dates
