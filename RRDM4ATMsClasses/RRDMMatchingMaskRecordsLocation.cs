...
namespace RRDM4ATMs
{
    public class RRDMMatchingMaskRecordsLocation : Logger
    {
        public RRDMMatchingMaskRecordsLocation() : base() { }
        ...
        // 
        public void ReadtblMatchingMaskSpecific(int InSeqNo, string InOperator, string InCategory, int InRunningJobNo)
        {
            RecordFound = false;
            ErrorFound = false;
            ErrorOutput = "";
            ...
            Rs.ReadMatchingCategoriesSessionsByCatAndRunningJobNo(InOperator, InCategory, InRunningJobNo);
                ...
                try
                {
                        ...
                        new SqlCommand(SqlString, conn))
                    {
                        ...
                        while (rdr.Read())
                        {
                            ...
                            Mpa.ReadMatchedORUnMatchedFileSpecificRecordBySeqNo(WhatFile, SeqNo01);

                                if (Mpa.RecordFound == true)
                                {
                                    RowSelected["CardNo"] = Mpa.CardNumber;
                                    RowSelected["Description"] = Mpa.TransDescr;
                                    RowSelected["Amount"] = Mpa.TransAmount;
                                    RowSelected["DateTime"] = Mpa.TransDate.ToString();
                            ...
                            Mpa.ReadMatchedORUnMatchedFileSpecificRecordBySeqNo(WhatFile, SeqNo02);
                            ...
                            else
                            {
                                ...
                                if (Rs.FileId31 != "")
                                {
                                    ...
                                    Mpa.ReadMatchedORUnMatchedFileSpecificRecordBySeqNo(WhatFile, SeqNo03);
                            ...
                            //**********************************************
                                ...
                                if (Rs.FileId41 != "")
                                {
                                    ...
                                    Mpa.ReadMatchedORUnMatchedFileSpecificRecordBySeqNo(WhatFile, SeqNo04);
                                ...
                                if (Rs.FileId51 != "")
                                {
                                    ...
                                    Mpa.ReadMatchedORUnMatchedFileSpecificRecordBySeqNo(WhatFile, SeqNo05);
