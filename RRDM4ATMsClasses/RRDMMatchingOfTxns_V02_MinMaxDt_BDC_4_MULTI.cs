...
namespace RRDM4ATMs
{
    public class RRDMMatchingOfTxns_V02_MinMaxDt_BDC_4_MULTI
    //: Logger
    {
        // public RRDMMatchingOfTxns_V02_MinMaxDt_BDC_4_MULTI() : base() { }
        /// <summary>
        ...
        public void Matching_FindGroupsForThisMatchingCategoryAndProcessPerGroup
                                      (string InOperator, string InSignedId,
                                       ...
                                       int InRMCycle, int InGroupId, string InReconcCategoryId, bool InTestingWorkingFiles)
        {
            ...
            // If this category has 14 groups then make : 
            // 14 loadings in temp tables and 14 matchings 
            //******************************************************
            //**********************
            ...
            if (NumberOfLoadedToWorkingTablesATMs > 0)
            {
                ...
                //
                //W_MPComment += DateTime.Now + "_" + "Working Files have been created:..for ATMs no... " + NumberOfLoadedToWorkingTablesATMs.ToString() + Environment.NewLine;
            ...
            // UPDATE THREAD BY RRDM AS FINISH 

            RRDM_THREADS Tr = new RRDM_THREADS();

            if (FoundThreadErrors == false)
            {
                // Errors not found in Thread
                Tr.UpdateEndOfThread_RRDMMatching(WMatchingCateg, WGroupId, WReconcCategoryId);
            }
        ...
        string WTempFileName01;
        string WTempFileName02;
        string WTempFileName03;

        string WTempFileName04; // For the unmatched
                                //DateTime LastDateTime;
        public void FIND_MinMaxFor_ALL_ATMS(string InOperator, string InSignedId,int InRMCycle)
        {
            ...
            while (I <= (TableThisGroupAtms.Rows.Count - 1))
            {
              ...
              //  WAtmsReconcGroup = (int)TableThisGroupAtms.Rows[I]["AtmsReconcGroup"];
                ...
                TableId = "[RRDM_Reconciliation_ITMX].[dbo].[tblMatchingTxnsMasterPoolATMs]";

                MaxDt01 = Mgt.ReadAndFindMaxDateTimeForMpaNoCategory(TableId, WAtmNo);


                TableId = "[RRDM_Reconciliation_ITMX].[dbo].[Switch_IST_Txns]";

                MaxDt02 = Mgt.ReadAndFindMaxDt_No_Category_ByATM(TableId, WAtmNo);
                ...
                TableId = "[RRDM_Reconciliation_ITMX].[dbo].[Flexcube]";
                ...
                Mm.InsertToMinMax(InRMCycle, WAtmNo, Mm.MinMaxDtTwoTables, Mm.MinMaxDtThreeTables);
                                                  ...
                                                  int WRMCycle, int InAtmsReconcGroup)
        {
                ...
                using (SqlConnection conn =
                 new SqlConnection(connectionStringATMs))
                    ...
                    catch (Exception ex)
                    {
                        ...
                        CatchDetails(ex, "Origin Location.." + "603.." + "..ATM_Reconc_Group" + InAtmsReconcGroup);
            ...
            if (FromOwnATMs == true)
            {
                ...
                while (I <= (TableThisGroupAtms.Rows.Count - 1))
                {
                    ...
                    //if ((WAtmNo == "01901105") & WMatchingCateg == "EMR206")
                    //{
                    //    MessageBox.Show("This is the ATM");
                    //}
                    ...
                    if (NumberOfTables == 2)
                    {
                        if (Mm.MinMaxDtTwoTables == NullPastDate)
                        {
                            I++; // Read Next entry of the table 
                            continue;
                        }
                    ...
                    if (NumberOfTables == 3)
                    {
                        ...
                        if (Mm.MinMaxDtThreeTables == NullPastDate)
                        {
                            I++; // Read Next entry of the table 
                            continue;
                        }
                    ...
                    if (NumberOfLoadedToWorkingTablesATMs == 0)
                    {
                        ...
                        WTempFileName01 = "Working_G" + InAtmsReconcGroup.ToString() + "_" + InMatchingCateg + "_01";
                        Method_CreateTemporary_Working(WTempFileName01);
                        WTempFileName01 = "[RRDM_TEMP_DB].[dbo]." + WTempFileName01;

                        // Second File
                        WTempFileName02 = "Working_G" + InAtmsReconcGroup.ToString() + "_" + InMatchingCateg + "_02";
                        Method_CreateTemporary_Working(WTempFileName02);
                        WTempFileName02 = "[RRDM_TEMP_DB].[dbo]." + WTempFileName02;
                        if (NumberOfTables == 3)
                        {
                            WTempFileName03 = "Working_G" + InAtmsReconcGroup.ToString() + "_" + InMatchingCateg + "_03";
                            Method_CreateTemporary_Working(WTempFileName03);
                            WTempFileName03 = "[RRDM_TEMP_DB].[dbo]." + WTempFileName03;
                        }

                        // File for the unmatched 
                        WTempFileName04 = "Working_G" + InAtmsReconcGroup.ToString() + "_" + InMatchingCateg + "_UnMatched";
                        Method_CreateTemporary_UnMatched(WTempFileName04);
                        // Method_CreateTemporary_Working(WTempFileName01);
                        WTempFileName04 = "[RRDM_TEMP_DB].[dbo]." + WTempFileName04;
                    ...
                    //
                    // FOR EACH ATM WITHIN THE CATEGORY _ GROUP INSERT 
                    //
                    ...
                    TempCount1 = Mtw.PopulateWorkingFile_ATMs_Working01_MULTI(WTempFileName01, SourceTable_A, WMatchingCateg, WRMCycle, WAtmNo, MinMaxDt_01);
                    ...
                    TempCount2 = Mtw.PopulateWorkingFile_ATMs_V02_MULTI(WTempFileName02, SourceTable_B, WMatchingCateg, WRMCycle, WAtmNo, MinMaxDt_02);
                    ...
                    if (NumberOfTables == 3)
                    {
                        ...
                        TempCount3 = Mtw.PopulateWorkingFile_ATMs_V03_MULTI(WTempFileName03, SourceTable_C, WMatchingCateg, WRMCycle, WAtmNo, MinMaxDt_03);
                    }
                    ...
                    TableId = SourceTable_B;
                    int WMode = 2;
                    Mgt.ReadTableAndFillTableWithDepositReversals_MULTI(WMatchingCateg, TableId, MinMaxDt_02, WAtmNo, WMode, WTempFileName02, WTempFileName03);

                    if (NumberOfTables == 3)
                    {
                        TableId = SourceTable_C;
                        WMode = 3;
                        Mgt.ReadTableAndFillTableWithDepositReversals_MULTI(WMatchingCateg, TableId, MinMaxDt_03, WAtmNo, WMode, WTempFileName02, WTempFileName03);
                    }
            ...
            if (FromOwnATMs == false)
            {
                ...
                {
                    Mpa.ReadAndFindRRNUMBER_NO_ATM(TableId, InMatchingCateg, MaxDt01, 1);
        ...
        //    SqlConnection conn2 = new SqlConnection(connectionStringATMs);
        //    conn2.Open();
        //    return conn2; 

        //}
        // CREATE TEMPORARY in RRDM_TEMP_DB
        private void Method_CreateTemporary_Working(string InFileName)
        {
            RecordFound = false;
            ErrorFound = false;
            ErrorOutput = "";
            ...
            string SPName = "[RRDM_TEMP_DB].[dbo].[stp_00_CREATE_Temp_Working_Table]";
                ...
                )
            {
                try
                {
                    ...
                    cmd.Parameters.Add(new SqlParameter("@TableName", InFileName));
                ...
                catch (Exception ex)
                {
                    ...
                    CatchDetails(ex, "Origin Location.." + "942..");
        ...
        // CREATE TEMPORARY in RRDM_TEMP_DB
        private void Method_CreateTemporary_UnMatched(string InFileName)
        {
            RecordFound = false;
            ErrorFound = false;
            ErrorOutput = "";
            ...
            string SPName = "[RRDM_TEMP_DB].[dbo].[stp_00_CREATE_Temp_Working_Table_UnMatchedResults]";
                ...
                )
            {
                ...
                catch (Exception ex)
                {
                    ...
                    // CatchDetails(ex, "943");
                    CatchDetails(ex, "Origin Location.." + "943.." + "..ATM_Reconc_Group" + WReconcCategoryId);
        ...
        public void UpdatingAfterMatching_OurATMs(string InOperator, string InMatchingCateg, string InReconcCateg, int InRMCycle)
        {
            // *********************************************************************
            ...
            ReadUnMatchedTxnsMasterPoolATMsTotalsForAtmsAND_UPDATE_OurATMs(InOperator, InMatchingCateg, InReconcCateg, InRMCycle, SelectionCriteria);
                                        ...
                                        int InRMCycle)
        {
            ...
            TableX = WTempFileName01;
            TableY = WTempFileName02;
            ...
            TableX = WTempFileName02;
            TableY = WTempFileName01;
            ...
            using (SqlConnection conn2 =
                ...
                catch (Exception ex)
                {
                    ...
                    // CatchDetails(ex, "604");
                    CatchDetails(ex, "Origin Location.." + "604.." + "..ATM_Reconc_Group" + WReconcCategoryId);

                    FoundThreadErrors = true;
                }

            //
            //Insert Records For WTempFileName04
            //
            using (SqlConnection conn2 =
                           new SqlConnection(connectionStringATMs))
                try
                {
                    ...
                    using (SqlBulkCopy s = new SqlBulkCopy(conn2))
                    {
                        s.DestinationTableName = WTempFileName04;
                ...
                catch (Exception ex)
                {
                    ...
                    // CatchDetails(ex, "605");
                    CatchDetails(ex, "Origin Location.." + "605.." + "..ATM_Reconc_Group" + WReconcCategoryId);
            ...
            using (SqlConnection conn2 =
                ...
                catch (Exception ex)
                {
                    ...
                    // CatchDetails(ex, "605");
                    CatchDetails(ex, "Origin Location.." + "606.." + "..ATM_Reconc_Group" + WReconcCategoryId);
                                        ...
                                        int InRMCycle)
        {
            ...
            using (SqlConnection conn2 =
                ...
                catch (Exception ex)
                {
                    ...
                    //CatchDetails(ex, "604");
                    CatchDetails(ex, "Origin Location.." + "607.." + "..ATM_Reconc_Group" + WReconcCategoryId);
            ...
            using (SqlConnection conn2 =
                ...
                catch (Exception ex)
                {
                    ...
                    CatchDetails(ex, "Origin Location.." + "608.." + "..ATM_Reconc_Group" + WReconcCategoryId);
            ...
            using (SqlConnection conn2 =
                ...
                catch (Exception ex)
                {
                    ...
                    //CatchDetails(ex, "609");
                    CatchDetails(ex, "Origin Location.." + "609.." + "..ATM_Reconc_Group" + WReconcCategoryId);
                                        ...
                                        int InRMCycle)
        {
            ...
            using (SqlConnection conn2 =
                ...
                catch (Exception ex)
                {
                    ...
                    // CatchDetails(ex, "610");
                    CatchDetails(ex, "Origin Location.." + "610.." + "..ATM_Reconc_Group" + WReconcCategoryId);
            ...
            using (SqlConnection conn2 =
                ...
                catch (Exception ex)
                {
                    ...
                    //CatchDetails(ex, "611");
                    CatchDetails(ex, "Origin Location.." + "611.." + "..ATM_Reconc_Group" + WReconcCategoryId);
            ...
            using (SqlConnection conn2 =
                ...
                catch (Exception ex)
                {
                    ...
                    CatchDetails(ex, "Origin Location.." + "612.." + "..ATM_Reconc_Group" + WReconcCategoryId);
                                        ...
                                        int InRMCycle)
        {
            ...
            using (SqlConnection conn2 =
                ...
                catch (Exception ex)
                {
                    ...
                    //CatchDetails(ex, "604");
                    CatchDetails(ex, "Origin Location.." + "613.." + "..ATM_Reconc_Group" + WReconcCategoryId);
            ...
            using (SqlConnection conn2 =
                ...
                catch (Exception ex)
                {
                    ...
                    //CatchDetails(ex, "614");
                    CatchDetails(ex, "Origin Location.." + "614.." + "..ATM_Reconc_Group" + WReconcCategoryId);
            ...
            using (SqlConnection conn2 =
                ...
                catch (Exception ex)
                {
                    ...
                    //CatchDetails(ex, "605");
                    CatchDetails(ex, "Origin Location.." + "615.." + "..ATM_Reconc_Group" + WReconcCategoryId);
            ...
            if (NumberOfUnmatched > 0 || NumberOfDublicates > 0)
            {
                ...
                using (SqlConnection conn2 =
                    ...
                    catch (Exception ex)
                    {
                        ...
                        //CatchDetails(ex, "606");
                        CatchDetails(ex, "Origin Location.." + "616.." + "..ATM_Reconc_Group" + WReconcCategoryId);
                ...
                using (SqlConnection conn2 =
                    ...
                    catch (Exception ex)
                    {
                        ...
                        //CatchDetails(ex, "605");
                        CatchDetails(ex, "Origin Location.." + "617.." + "..ATM_Reconc_Group" + WReconcCategoryId);
                ...
                using (SqlConnection conn2 =
                    ...
                    catch (Exception ex)
                    {
                        ...
                        //CatchDetails(ex, "607");
                        CatchDetails(ex, "Origin Location.." + "618.." + "..ATM_Reconc_Group" + WReconcCategoryId);
       ...
       + " ";
            ...
            using (SqlConnection conn =
                ...
                catch (Exception ex)
                {
                    ...
                    //CatchDetails(ex, "608");
                    CatchDetails(ex, "Origin Location.." + "619.." + "..ATM_Reconc_Group" + WReconcCategoryId);
                                ...
                                string InFileIdB, string InCase, int InPos, int NotInPos, string InMatchingFields)
        {
            ...
            using (SqlConnection conn =
                ...
                catch (Exception ex)
                {
                    ...
                    // CatchDetails(ex, "610");
                    CatchDetails(ex, "Origin Location.." + "620.." + "..ATM_Reconc_Group" + WReconcCategoryId);
                                     ...
                                     , string InMatchingFields, string InMatchingCateg, int InRMCycle)
        {
            ...
            using (SqlConnection conn =
                ...
                catch (Exception ex)
                {
                    ...
                    // CatchDetails(ex, "610");
                    CatchDetails(ex, "Origin Location.." + "621.." + "..ATM_Reconc_Group" + WReconcCategoryId);
                                       ...
                                       string InCase, int InPos, int NotInPos, int InRMCycle, DateTime InLimitDate)
        {
            ...
            using (SqlConnection conn =
                ...
                catch (Exception ex)
                {
                    ...
                    //CatchDetails(ex, "610");
                    CatchDetails(ex, "Origin Location.." + "622.." + "..ATM_Reconc_Group" + WReconcCategoryId);
                                       ...
                                       string InCase, int InPos, int NotInPos, int InRMCycle, DateTime InLimitDate)
        {
            ...
            using (SqlConnection conn =
                ...
                catch (Exception ex)
                {
                    ...
                    // CatchDetails(ex, "610");
                    CatchDetails(ex, "Origin Location.." + "623.." + "..ATM_Reconc_Group" + WReconcCategoryId);
            ...
            using (SqlConnection conn =
             new SqlConnection(connectionStringATMs))
                ...
                catch (Exception ex)
                {
                    ...
                    //CatchDetails(ex, "611");
                    CatchDetails(ex, "Origin Location.." + "624.." + "..ATM_Reconc_Group" + WReconcCategoryId);
        ...
        public void ReadExceptionsAndCompressAndUpdatefor_3_Tables()
        {
            ...
            using (SqlConnection conn =
             new SqlConnection(connectionStringATMs))
                ...
                catch (Exception ex)
                {
                    ...
                    //CatchDetails(ex, "612");
                    CatchDetails(ex, "Origin Location.." + "625.." + "..ATM_Reconc_Group" + WReconcCategoryId);
            ...
            while (I <= (TableUnMatched.Rows.Count - 1))
            {
                ...
                //if (TerminalId == "AB1V0015" & TraceNo == 88217)
                //{
                //    MessageBox.Show("This is the terminal AB1V0015");
                //}
        ...
        private void InsertAndUpdateTablesFromOurAtms_AND_JCC(string WWMask)
        {
            ...
            try
            {
                ...
                if (WMatchingCateg.Substring(3, 3) == "231" || WMatchingCateg.Substring(3, 3) == "233")
                {
                    MasterPOS = true;
                }
                      ...
                      )
                {
                    ...
                    if (Mgt.RecordFound)
                    {
                        ...
                        Mpa.OriginFileName = "ATM:" + Mgt.TerminalId + " Journal";
                        ...
                        //    // Update record as not matched. 
                        //    // Update SourceTable_B
                        //    Mgt_BDC.UpdateRecordForMaskBySeqNumber(SourceTable_B, SeqNoInTwo, WWMask);
            ...
            catch (Exception ex)
            {
                ...
                CatchDetails(ex, "Origin Location.." + "640.." + "Mask.." + WWMask + "..ATM_Reconc_Group" + WReconcCategoryId);
            }
        ...
        public void ReadDublicatesAndCompressAndUpdateExceptionsforTables()
        {
            ...
            SqlString =
            " SELECT  *"
                + " FROM " + WTempFileName04 // leave it as is 
            ...
            using (SqlConnection conn =
             new SqlConnection(connectionStringATMs))
                ...
                catch (Exception ex)
                {
                    ...
                    //CatchDetails(ex, "613");
                    CatchDetails(ex, "Origin Location.." + "626.." + "..ATM_Reconc_Group" + WReconcCategoryId);
...

        {
            ...
            using (SqlConnection conn = new SqlConnection(InConnectionString))
                ...
                catch (Exception ex)
                {
                    ...
                    // CatchDetails(ex, "615");
                    CatchDetails(ex, "Origin Location.." + "627..");
        ...
        public void ReadUnMatchedTxnsMasterPoolATMsTotalsForAtmsAND_UPDATE_OurATMs(string InOperator, string InMatchingCateg, string InRMCateg, int InRMCycle, string InSelectionCriteria)
        {
            RMCateg = InRMCateg;
            ...
            using (SqlConnection conn =
                    ...
                    using (SqlDataAdapter sqlAdapt = new SqlDataAdapter(SqlString, conn))
                    {
                        ...
                        while (I <= (DataTableAtmsTotals.Rows.Count - 1))
                        {
                            ...
                            Ratms.ReadReconcCategoriesATMsRMCycleSpecific
                                                 (InOperator, RMCateg, InRMCycle, TerminalId);
                            if (Ratms.RecordFound)
                            {
                                ...
                                catch (Exception ex)
                                {
                                    ...
                                    //CatchDetails(ex, "614");
                                    CatchDetails(ex, "Origin Location.." + "628.." + "..ATM_Reconc_Group" + WReconcCategoryId);
                            ...
                            else
                            {
                                ...
                                Ratms.ReconcCategoryId = RMCateg.Trim();
                                ...
                                Ratms.OwnerUserID = "SystemAtMatching";
                                ...
                                if (Ratms.RecordFound)
                                {
                                    ...
                                    catch (Exception ex)
                                    {
                                        ...
                                        //CatchDetails(ex, "615");
                                        CatchDetails(ex, "Origin Location.." + "629.." + "..ATM_Reconc_Group" + WReconcCategoryId);
                        ...
                        string WSelectionCriteria = " WHERE "
                            + "  MatchingCateg ='" + MatchingCateg + "' AND  RMCateg ='" + RMCateg + "'"
                        ...
                        Rcs.ReadReconcCategorySessionByCatAndRunningJobNo(InOperator, RMCateg, InRMCycle);
                        ...
                        // Update Matching Category as passing Matched. 
                        Rcs.UpdateReconcCategorySessionAtOpeningNewCycleCat01(InOperator, InRMCycle, RMCateg, MatchingCateg);
                        Rcs.UpdateReconcCategorySessionAtOpeningNewCycleCat02(InOperator, InRMCycle, RMCateg, MatchingCateg);
                        Rcs.UpdateReconcCategorySessionAtOpeningNewCycleCat03(InOperator, InRMCycle, RMCateg, MatchingCateg);
                        Rcs.UpdateReconcCategorySessionAtOpeningNewCycleCat04(InOperator, InRMCycle, RMCateg, MatchingCateg);
                        Rcs.UpdateReconcCategorySessionAtOpeningNewCycleCat05(InOperator, InRMCycle, RMCateg, MatchingCateg);
                        Rcs.UpdateReconcCategorySessionAtOpeningNewCycleCat06(InOperator, InRMCycle, RMCateg, MatchingCateg);
                        Rcs.UpdateReconcCategorySessionAtOpeningNewCycleCat07(InOperator, InRMCycle, RMCateg, MatchingCateg);
                        Rcs.UpdateReconcCategorySessionAtOpeningNewCycleCat08(InOperator, InRMCycle, RMCateg, MatchingCateg);
                        Rcs.UpdateReconcCategorySessionAtOpeningNewCycleCat09(InOperator, InRMCycle, RMCateg, MatchingCateg);

                        Rcs.ReadReconcCategorySessionByCatAndRunningJobNo(InOperator, RMCateg, InRMCycle);
                        //MessageBox.Show(Rcs.MPComment);
                        Rcs.MPComment += DateTime.Now + "_" + "Matching Has Been Completed_For_RMCate.." + RMCateg + "MatchingCateg.." + MatchingCateg + Environment.NewLine;
                        // W_MPComment += DateTime.Now + "_________________________" + Environment.NewLine;
                        Rcs.UpdateReconcCategorySessionAtMatchingProcess_MPComment(RMCateg, InRMCycle, Rcs.MPComment);
                ...
                catch (Exception ex)
                {
                    ...
                    //CatchDetails(ex, "616");
                    CatchDetails(ex, "Origin Location.." + "630.." + "..ATM_Reconc_Group" + WReconcCategoryId);
            ...
            // 
            RRDMReconcFileMonitorLog Rfm = new RRDMReconcFileMonitorLog();
            string File_Selection = "WHERE SourceFileID ='NCR_FOREX' AND RMCycleNo =" + InRMCycle;
            Rfm.ReadLoadedFilesAND_Find_If_Loaded(File_Selection);
            if (Rfm.RecordFound == true)
            {
                // Update 09 for those that do not have records 
                Rcs.UpdateReconcCategorySessionAtOpeningNewCycleCat09(InOperator, InRMCycle, RMCateg, MatchingCateg);
            }
        ...
        public void ReadUnMatchedTxnsMasterPoolATMsTotals_AND_Update_Mode_2(string InOperator, int InRMCycle, string InSelectionCriteria)
        {
            ...
            using (SqlConnection conn =
                ...
                catch (Exception ex)
                {
                    ...
                    // CatchDetails(ex, "617");
                    CatchDetails(ex, "Origin Location.." + "631.." + "..ATM_Reconc_Group" + WReconcCategoryId);
            ...
            catch (Exception ex)
            {
                ...
                //CatchDetails(ex, "618");
                CatchDetails(ex, "Origin Location.." + "632.." + "..ATM_Reconc_Group" + WReconcCategoryId);
     ...
     + " WHERE t1.MatchingCateg = @MatchingCateg AND t1.MatchingAtRMCycle = @MatchingAtRMCycle ", conn))
                ...
                catch (Exception ex)
                {
                    ...
                    //CatchDetails(ex, "619");
                    CatchDetails(ex, "Origin Location.." + "633.." + "..ATM_Reconc_Group" + WReconcCategoryId);
        ...
        private static void CatchDetails(Exception ex, string InOrigin)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("There is a system error with ID = " + Log.ErrorNo.ToString() + Environment.NewLine
                     + " Error In Multithreading " + Environment.NewLine
                     + " For.." + InOrigin + Environment.NewLine
                    + " Call controller to take care. ");
            }
            //  Environment.Exit(0);
        }
    }
