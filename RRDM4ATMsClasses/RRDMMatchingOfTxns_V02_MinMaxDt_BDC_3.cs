...
namespace RRDM4ATMs
{
    public class RRDMMatchingOfTxns_V02_MinMaxDt_BDC_3 : Logger
    {
        public RRDMMatchingOfTxns_V02_MinMaxDt_BDC_3() : base() { }
        /// <summary>
                                       ...
                                       int InRMCycle)
        {
            ...
            while (I <= (Mc.TableMatchingCateg.Rows.Count - 1))
            {
                ...
                //    Message = "THIS THE ONE - " + WMatchingCateg + " MASTER POS   ";
                                       ...
                                       int InRMCycle, bool InTestingWorkingFiles)
        {
            ...
            if (FromOwnATMs == true)
            {
                ...
                while (I <= (TableThisCategoryGroups.Rows.Count - 1))
                {
                    ...
                    //if (WReconcCategoryId == "RECATMS-112"
                    //    )
                    //{
                                                  ...
                                                  int WRMCycle, int InAtmsReconcGroup)
        {
            ...
            if (FromOwnATMs == true)
            {
                ...
                while (I <= (TableThisGroupAtms.Rows.Count - 1))
                {
                    ...
                    //if ((WAtmNo == "00000530" || WAtmNo == "00000943") & InMatchingCateg == PRX+"202")
                    //{
                    ...
                    if (NumberOfTables == 2)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                MinMaxDt_01 = MinMaxDt;
                                // Find Details of Last Reocord in FileA
                                Mpa.ReadInPoolTransSpecificDuringMatching(WMatchingCateg, WAtmNo, MaxDt01, 1);
                                ...
                                else
                                {
                                    if (ShowMessage == true & Environment.UserInteractive)
                                    {
                                        System.Windows.Forms.MessageBox.Show("ERROR 1058...FOR.." + WAtmNo + "..DATE.." + MinMaxDt.ToString());
                                ...
                                TableId = SourceTable_B;
                                MinMaxDt_02 = Mgt.ReadAndFindDateBasedOnDetails(TableId, WMatchingCateg, WAtmNo, Mpa.TransDate.Date,
                                ...
                                else
                                {
                                    ...
                                    if (ShowMessage == true & Environment.UserInteractive)
                                    {
                                        System.Windows.Forms.MessageBox.Show("ERROR 1059...FOR.." + WAtmNo + "..DATE.." + MinMaxDt.ToString());
                                    }
                            ...
                            if (MaxDt02 == MinMaxDt)
                            {
                                ...
                                Mgt.ReadAndFindDetails(TableId, WMatchingCateg, WAtmNo, MaxDt02);
                                ...
                                else
                                {
                                    if (ShowMessage == true & Environment.UserInteractive)
                                    {
                                        System.Windows.Forms.MessageBox.Show("ERROR 1060...FOR.." + WAtmNo + "..DATE.." + MinMaxDt.ToString());
                                    }
                                ...
                                MinMaxDt_01 = Mpa.ReadInPoolTransSpecificDuringMatching_2(WMatchingCateg, WAtmNo, Mgt.TransDate.Date
                                ...
                                else
                                {
                                    if (ShowMessage == true & Environment.UserInteractive)
                                    {
                                        System.Windows.Forms.MessageBox.Show("ERROR 1061...FOR.." + WAtmNo + "..DATE.." + MinMaxDt.ToString());
                                    }
                        ...
                        else
                        {
                            ...
                            if (MaxDt01 == MinMaxDt)
                            {
                                ...
                                else
                                {
                                    if (ShowMessage == true & Environment.UserInteractive)
                                    {
                                        System.Windows.Forms.MessageBox.Show("ERROR 1078...FOR.." + WAtmNo + "..DATE.." + MinMaxDt.ToString());
                                    }
                                ...
                                else
                                {
                                    ...
                                    if (ShowMessage == true & Environment.UserInteractive)
                                    {
                                        System.Windows.Forms.MessageBox.Show("ERROR 1079...FOR.." + WAtmNo + "..DATE.." + MinMaxDt.ToString());
                                    }

                                    I++; // Read Next entry of the table 
                                    continue;
                                }
                                // Based on Details Locate exact DateTime on File C
                                TableId = SourceTable_C;

                                if (TwoAndThreeIsRRN == true)

                                {
                                    // Two and three based on RRNumber 
                                    MinMaxDt_03 = Mgt.ReadAndFindDateBasedOnDetails_2_Based_On_RRN(TableId, WMatchingCateg, WAtmNo, Mpa.TransDate.Date,
                                                   Mgt.RRNumber, Mpa.TransAmount, Mpa.CardNumber, Mpa.AccNumber);
                                }
                                else
                                {
                                    MinMaxDt_03 = Mgt.ReadAndFindDateBasedOnDetails_2(TableId, WMatchingCateg, WAtmNo, Mpa.TransDate.Date,
                                                       Mpa.TraceNoWithNoEndZero, Mpa.TransAmount, Mpa.CardNumber, Mpa.AccNumber);
                                ...
                                else
                                {
                                    ...
                                    if (ShowMessage == true & Environment.UserInteractive)
                                    {
                                        System.Windows.Forms.MessageBox.Show("ERROR 1080...FOR.." + WAtmNo + "..DATE.." + MinMaxDt.ToString());
                                    }
                            ...
                            if (MaxDt02 == MinMaxDt & Pastthrough == false)
                            {
                                Pastthrough = true;
                                MinMaxDt_02 = MinMaxDt;
                                // Find Details of Last Reocord in FileB
                                ...
                                else
                                {
                                    if (ShowMessage == true & Environment.UserInteractive)
                                    {
                                        System.Windows.Forms.MessageBox.Show("ERROR 1081...FOR.." + WAtmNo + "..DATE.." + MinMaxDt.ToString());
                                    }
                                ...
                                // Based on Details Locate exact DateTime on File A
                                MinMaxDt_01 = Mpa.ReadInPoolTransSpecificDuringMatching_2(WMatchingCateg, WAtmNo, Mgt.TransDate.Date
                                                                     , Mgt.TraceNo, Mgt.TransAmt, Mgt.CardNumber, Mgt.AccNo, 1);
                                ...
                                else
                                {
                                    if (ShowMessage == true & Environment.UserInteractive)
                                    {
                                        System.Windows.Forms.MessageBox.Show("ERROR 1082.." + WAtmNo + "..DATE.." + MinMaxDt.ToString());
                                    }
                                ...
                                if (TwoAndThreeIsRRN == true)
                                {
                                    ...
                                    MinMaxDt_03 = Mgt.ReadAndFindDateBasedOnDetails_2_Based_On_RRN(TableId, WMatchingCateg, WAtmNo, Mgt.TransDate.Date
                                                                  , Mgt.RRNumber, Mgt.TransAmt, Mgt.CardNumber, Mgt.AccNo);
                                }
                                else
                                {
                                    MinMaxDt_03 = Mgt.ReadAndFindDateBasedOnDetails_2(TableId, WMatchingCateg, WAtmNo, Mgt.TransDate.Date
                                ...
                                else
                                {
                                    ...
                                    if (ShowMessage == true & Environment.UserInteractive)
                                    {
                                        System.Windows.Forms.MessageBox.Show("ERROR 1083...FOR.." + WAtmNo + "..DATE.." + MinMaxDt.ToString());
                                    }
                            ...
                            if (MaxDt03 == MinMaxDt & Pastthrough == false)
                            {
                                Pastthrough = true;
                                MinMaxDt_03 = MinMaxDt;
                                // Find Details of Last Reocord in File C
                                TableId = SourceTable_C;

                                Mgt.ReadAndFindDetails(TableId, WMatchingCateg, WAtmNo, MaxDt03);
                                ...
                                else
                                {
                                    if (ShowMessage == true & Environment.UserInteractive)
                                    {
                                        System.Windows.Forms.MessageBox.Show("ERROR 1084...FOR.." + WAtmNo + "..DATE.." + MinMaxDt.ToString());
                                    }
                                ...
                                if (TwoAndThreeIsRRN == true)
                                {
                                    ...
                                    MinMaxDt_02 = Mgt.ReadAndFindDateBasedOnDetails_2_Based_On_RRN(TableId, WMatchingCateg, WAtmNo, Mgt.TransDate.Date
                                                                  , Mgt.RRNumber, Mgt.TransAmt, Mgt.CardNumber, Mgt.AccNo);

                                }
                                else
                                {
                                    MinMaxDt_02 = Mgt.ReadAndFindDateBasedOnDetails(TableId, WMatchingCateg, WAtmNo, Mgt.TransDate.Date
                                                                     , Mgt.TraceNo, Mgt.TransAmt, Mgt.CardNumber, Mgt.AccNo);
                                ...
                                else
                                {
                                    ...
                                    if (ShowMessage == true & Environment.UserInteractive)
                                    {
                                        System.Windows.Forms.MessageBox.Show("ERROR 1086...FOR.." + WAtmNo + "..DATE.." + MinMaxDt.ToString());
                                    }
                                ...
                                else
                                {
                                    if (ShowMessage == true & Environment.UserInteractive)
                                    {
                                        System.Windows.Forms.MessageBox.Show("ERROR 1085...FOR.." + WAtmNo + "..DATE.." + MinMaxDt.ToString());
                                    }
                    ...
                    //Coff.DefineLastTraces(WOperator, WMatchingCateg, TableId, WAtmNo, WRMCycle);
                    //if (Coff.NoTxns == true)
                    //{
                    //    //I++;
                    //    //continue;
                    ...
                    if (MinMaxDt != NullPastDate)
                    {
                        ...
                        if (WTestingWorkingFiles == false)
                            Mtw.PopulateWorkingFile_ATMs_Working01("01", SourceTable_A, WMatchingCateg, WRMCycle, WAtmNo, MinMaxDt_01);
                        ...
                        if (WTestingWorkingFiles == false)
                            ...
                            Mtw.PopulateWorkingFile_ATMs_V02("02", SourceTable_B, WMatchingCateg, WRMCycle, WAtmNo, MinMaxDt_02);
                        ...
                        if (NumberOfTables == 3)
                        {
                            ...
                            if (WTestingWorkingFiles == false)
                                ...
                                Mtw.PopulateWorkingFile_ATMs_V03("03", SourceTable_C, WMatchingCateg, WRMCycle, WAtmNo, MinMaxDt_03);
                        }
                        //
                        ...
                        //TableId = SourceTable_B;
                        //Mgt_BDC.UpdateMpaWithSeqNoForTables_Atms(InReconcCateg, TableId, WAtmNo,
                        //                         WRMCycle);
       ...
       + " ";
        ...
        public void ReadExceptionsAndCompressAndUpdatefor_3_Tables()
        {
            ...
            while (I <= (TableUnMatched.Rows.Count - 1))
            {
                ...
                //if (TerminalId == "00000716")
                //{
                //    MessageBox.Show("This is the terminal 00000716"); 
                //}
        ...
        private void InsertAndUpdateTablesFromOurAtms_AND_JCC(string WWMask)
        {
                ...
                )
            {
                ...
                {
                    MessageBox.Show("1829 : Check for System Error ");
                }
                ...
                if (Mpa.RecordFound == true)
                {
                    ...
                    if (FoundInTwo_Reversals == true || FoundInThree_Reversals == true)
                    {
                        ...
                        if (WWMask == "110" & FoundInThree_Reversals == true)
                        {
                            // case 110
                            WWMask = "11R";
                        }
                    ...
                    else
                    {
                        ...
                        if (Gp.RecordFound == true || WMatchingCateg == "BDC240")
                        {
                            //
