...
namespace RRDM4ATMs
{
    public class RRDMAuthorisationProcess
    {
        //      
        //
...
// Following two fields needed for Replenishment 
       ...
       public string Operator;
        ...
        //
        public void ReadAuthorizationForReplenishmentReconcSpecific(string InAtmNo, int InReplCycle, string InOrigin)
        {
            RecordFound = false;
            ErrorFound = false;
            ErrorOutput = "";
            ...
            string SqlString = "SELECT *"
               + " FROM [dbo].[AuthorizationTable]"
               + " WHERE AtmNo = @AtmNo AND ReplCycle = @ReplCycle AND Origin = @Origin ";
...
// READ LAST AUTHORIAZATION FOR THIS ORIGINATOR 
        ...
        public void GetMessageOne(string InAtmNo, int InSesNo,string InOrigin ,bool InAuthoriser, bool InRequestor, bool Reject)
        {
            ...
            ReadAuthorizationForReplenishmentReconcSpecific(InAtmNo, InSesNo, InOrigin);
