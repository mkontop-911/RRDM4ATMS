...
namespace RRDM4ATMs
{
    public class RRDMMatchingOfTxns_V02_MinMaxDt_BDC_4_ROM : Logger
    {
        public RRDMMatchingOfTxns_V02_MinMaxDt_BDC_4_ROM() : base() { }
        /// <summary>
        ...
        RRDMMatchingTxns_InGeneralTables_ROM Mgt = new RRDMMatchingTxns_InGeneralTables_ROM();
                                                  ...
                                                  int WRMCycle, int InAtmsReconcGroup)
        {
            ...
            if (FromOwnATMs == true)
            {
                ...
                while (I <= (TableThisGroupAtms.Rows.Count - 1))
                {
                    ...
                    TempCount1 = Mtw.PopulateWorkingFile_ATMs_Working01_ROM("01", SourceTable_A, WMatchingCateg, WRMCycle, WAtmNo, MinMaxDt_01);
                    ...
                    TempCount2 = Mtw.PopulateWorkingFile_ATMs_V02_ROM("02", SourceTable_B, WMatchingCateg, WRMCycle, WAtmNo, MinMaxDt_02);
            ...
            if (FromOwnATMs == false)
            {
                ...
                if (PRX == "EMR")
                {
                    if (InMatchingCateg == "EMR204")
                    {
                        InMatchingCateg = "EMR204";
                    }
        ...
        private void UnmatchedTableFieldsDefinition()
        {
            ...
            TableUnMatched.Columns.Add("UTRNNO", typeof(string));
       ...
       + " ";
                ...
                try
                {
                        ...
                        new SqlCommand(SqlString, conn))
                    {
                        ...
                        while (rdr.Read())
                        {
                            ...
                            if (FromOwnATMs == true)
                            {
                                //RowSelected["Matched_Characters"] = TerminalId + TransDate.Date.ToString() + UTRNNO + "_" + TransAmt.ToString() ;
        ...
        public void ReadExceptionsAndCompressAndUpdatefor_2_Tables()
        {
            ...
            while (I <= (TableUnMatched.Rows.Count - 1))
            {
                ...
                UTRNNO = (string)TableUnMatched.Rows[I]["UTRNNO"];
                    ...
                    if (Mpa.RecordFound == true)
                    {
                        ...
                        if (WWMask.Substring(1, 1) == "0")
                        {
                            if (FromOwnATMs == true)
                            {
                                ...
                                Mgt.ReadAndFindDateBasedOnDetails_2_ROM(SourceTable_B, WMatchingCateg, Mpa.TerminalId, Mpa.TransDate.Date
                                                                   , Mpa.UTRNNO, Mpa.TransAmount, Mpa.CardNumber);
                            ...
                            if (Mgt.RecordFound == true & Mgt.Comment == "Reversals")
                            {
                                ...
                                if (FromOwnATMs == true)
                                {
                                    ...
                                    Mgt.UpdateReversalsForMask_By_Trace(SourceTable_B, WMatchingCateg, Mpa.TerminalId, Mpa.TransDate.Date
                                                                   , Mpa.UTRNNO, Mpa.TransAmount, Mpa.CardNumber, WWMask);
                                }
                                else
                                {
                        ...
                        // OR Maybe Kill them? 
                        bool istimeconsuming = true;
                        if ((WWMask == "10" || WWMask == "100") & FromOwnATMs == true  & istimeconsuming == false)
                        {
                                                                                     ...
                                                                                     & Mgt.Comment == "Reversals")
                            {
                                ...
                                if (FromOwnATMs == true)
                                {
                                    Mgt.UpdateReversalsForMask_By_Trace(SourceTable_B, WMatchingCateg, Mgt.TerminalId, Mgt.TransDate.Date
                                                                   , Mgt.UTRNNO, Mgt.TransAmt, Mgt.CardNumber, WWMask);
                                }
                                else
                                {
