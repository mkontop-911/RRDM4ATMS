...
namespace RRDM4ATMs
{
    public class RRDM_LoadFiles_InGeneral_EMR_BDC_T24 : Logger
    {
        public RRDM_LoadFiles_InGeneral_EMR_BDC_T24() : base() { }
        //
                ...
                case "COREBANKING":
                    {
                        ...
                        if (MeezaIsPresent == true & WCut_Off_Date >= MeezaNewVersionDt)
                        {
                            InsertRecords_GTL_COREBANKING_3(InTableA, InFullPath, WReconcCycleNo);
                        }
                        else
                        {
                          ...
                          , int InReconcCycleNo)
        {
            ...
            SQLCmd = "INSERT INTO [RRDM_Reconciliation_ITMX].[dbo].[Switch_IST_Txns]"
                + "( "
                 ...
                 + " ,@Origin "
                   + " ,case "
                   + " WHEN (TXNSRC = '1' AND TXNDEST = '1' AND left([TXN], 2) <> '81')  THEN '" + PRX + "101' " // Only DEBIT CARD for COREBANKING
                   ...
                   + " WHEN (TXNSRC = '1' AND TXNDEST = '12') AND left([TXN], 2) <> '81'  THEN '" + PRX + "199'" // Prepaid 
                   + " WHEN (TXNSRC = '1' AND TXNDEST = '13' AND left([TXN], 2) = '81' AND AMOUNT <> '0') "
                  ...
                  + " WHEN (TXNSRC = '8' AND TXNDEST= '1' AND TXN <> '0-POS Purchase') "
                   ...
                   + " WHEN (TXNSRC = '18' AND TXNDEST= '1' AND TXN <> '0-POS Purchase') "
                                         + " THEN '" + PRX + "170' " // All incoming MEEZA DEBIT
                   + " WHEN (TXNSRC = '18' AND TXNDEST= '12' AND TXN <> '0-POS Purchase') "
                                         + " THEN '" + PRX + "271' " // All incoming MEEZA PREPAID
                   + " WHEN (TXNSRC = '18' AND TXNDEST= '1' AND TXN = '0-POS Purchase') THEN '" + PRX + "172' " // All incoming 123 NET - MEEZA - POS DEBIT
                   ...
                   + " WHEN (TXNSRC = '5' AND TXNDEST = '1') AND TXN <> '0-POS Purchase' AND left([TXN], 2) <> '30' THEN '" + PRX + "130' " // All Incoming Master to COREBANKING
                   + " WHEN (TXNSRC = '5' AND TXNDEST = '12') AND TXN <> '0-POS Purchase' AND left([TXN], 2) <> '30' THEN '" + PRX + "232' " // All Incoming Master to Prepaid
                   + " WHEN (TXNSRC = '5' AND TXNDEST ='1') AND (TXN = '0-POS Purchase' OR left([TXN], 2) = '30' ) THEN '" + PRX + "131' " // All Incoming POS
                   ...
                   + " WHEN (left([TXN], 6) = '810022' AND TXNDEST = '1') THEN '" + PRX + "150' " // FAWRY THAT GOES TO COREBANKING
                ...
                + "( "
                 ...
                 + " ,[Origin] "
                  ...
                  + " WHEN (TXNSRC = '1' AND TXNDEST = '8') THEN '" + PRX + "215' " // All outgoing 123 
                   ...
                   + " WHEN TXNSRC = '1' AND left([TransDescr], 6) = '810022' AND (TXNDEST = 1 OR TXNDEST = 12) THEN '" + PRX + "251'  " // FAWRY THAT GOES TO COREBANKING OR 12 prepaid
      ...
      + " ,case"
          ...
          + ", [SET_DATE] "
            ...
            SQLCmd = "UPDATE [RRDM_Reconciliation_ITMX].[dbo].[Switch_IST_Txns] "
               ...
               + " WHERE   Processed = 0 AND left([TransDescr], 6) = '810022' AND MatchingCateg <> '" + PRX + "150'  "
                + " "
                ;
                          ...
                          , int InReconcCycleNo)
        {
           ...
           + " ORDER by TERMID, [LOCAL_DATE],[LOCAL_TIME] "
            ...
            //           + " WHEN (TXNSRC = '5' AND TXNDEST = '1') AND TXN <> '0-POS Purchase' AND left([TXN], 2) <> '30' THEN '" + PRX + "230' " // All Incoming Master to COREBANKING
            //           + " WHEN (TXNSRC = '5' AND TXNDEST = '12') AND TXN <> '0-POS Purchase' AND left([TXN], 2) <> '30' THEN '" + PRX + "232' " // All Incoming Master to Prepaid
      ...
      + " ,case"
                          ...
                          , int InReconcCycleNo)
        {
            ...
            //        stpErrorText = stpErrorText + "Cancel " + PRX + "_IST With TAP LOADED_BULK_Records Insert";
            //        if (Environment.UserInteractive)
            //        {
            //            MessageBox.Show(stpErrorText + "..Please Check..Data_Format of.." + Environment.NewLine
            //            + WFullPath_01
            ...
            SQLCmd = "INSERT INTO [RRDM_Reconciliation_ITMX].[dbo].[Switch_IST_Txns]"
                + "( "
                 ...
                 + " ,@Origin "
                  ...
                  + " WHEN (TXNSRC = '8' AND TXNDEST= '1' AND TXN <> '0-POS Purchase') "
                                         //  + "  AND (LEFT([MASK_PAN],6) = '526402' )"
                                         + " THEN '" + PRX + "177' " // All incoming MEEZA - DEBIT
                   + " WHEN (TXNSRC = '8' AND TXNDEST= '12' AND TXN <> '0-POS Purchase') "
                                         // + " AND LEFT([MASK_PAN],6) <> '526402') "
                                         + " THEN '" + PRX + "278' " // All incoming MEEZA - NON DEBIT
                                                                     ...
                                                                     //+ " WHEN (TXNSRC = '18' AND TXNDEST= '12' AND TXN <> '0-POS Purchase') "
                                                                     //                      + " THEN '" + PRX + "271' " // All incoming MEEZA PREPAID
                   + " WHEN (TXNSRC = '8' AND TXNDEST= '1' AND TXN = '0-POS Purchase') THEN '" + PRX + "172' " // All incoming - MEEZA - POS DEBIT
                   + " WHEN (TXNSRC = '8' AND TXNDEST= '12' AND TXN = '0-POS Purchase') THEN '" + PRX + "273' " // All incoming  - MEEZA - POS NON DEBIT
                   + " WHEN (TXNSRC = '4' AND TXNDEST = '1') THEN '" + PRX + "220' " // All Incoming Visa
                   + " WHEN (TXNSRC = '5' AND TXNDEST = '1') AND TXN <> '0-POS Purchase' AND left([TXN], 2) <> '30' AND Left(TXN,4) <> '2000' THEN '" + PRX + "130' " // All Incoming Master to COREBANKING
                   ...
                   + " WHEN (TXNSRC = '5' AND TXNDEST ='1') AND (TXN = '0-POS Purchase' OR left([TXN], 2) = '30' OR  Left(TXN,4) = '2000') THEN '" + PRX + "131' " // All Incoming POS
                 ...
                 + " else '10' "
                 + "end "
                 + " , CAST(ISNULL(try_convert(datetime, [LOCAL_DATE], 103 ), '1900-01-01') AS DateTime)"  // TRANSACTION DATE
                    //+ ", CAST([LOCAL_DATE] as datetime) "
                    + "+ CAST(substring(right('000000' + [LOCAL_TIME], 6), 1, 2) + ':' "
                    + "+ substring(right('000000' + [LOCAL_TIME], 6), 3, 2)"
                    + " + ':' + substring(right('000000' + [LOCAL_TIME], 6), 5, 2) as datetime)"
                 ...
                 + ", @Operator"
                  + ", ltrim(rtrim([TXNSRC]))"
                   + ", ltrim(rtrim([TXNDEST]))"
                     // + ", CAST([TRANDATE] as datetime) " // EXTERNAL DATE
                      + " , CAST(ISNULL(try_convert(datetime, [TRANDATE], 103 ), '1900-01-01') AS Date)" // EXTERNAL DATE
                     //+ "+ CAST(substring(right('000000' + [TRANTIME], 6), 1, 2) + ':' "
                     //+ "+ substring(right('000000' + [TRANTIME], 6), 3, 2)"
                     //+ " + ':' + substring(right('000000' + [TRANTIME], 6), 5, 2) as datetime)"
                   ...
                   //   + ", CAST([CAP_DATE] as date) " // CAP_DATE
                      + " , CAST(ISNULL(try_convert(datetime, [CAP_DATE], 103 ), '1900-01-01') AS Date)"
                     
                    //  + ", CAST([SETTLEMENT_DATE] as date) "
                        + " , CAST(ISNULL(try_convert(datetime, [SETTLEMENT_DATE], 103 ), '1900-01-01') AS Date)"
                    + " FROM [RRDM_Reconciliation_ITMX].[dbo].BULK_" + InOriginFileName
                 + " WHERE  "
           + " ( "
           + " (left([TXN], 2) IN "
      ...
      + " ,case"
        ...
        public void HandleReversals_IST(string InTable_DB_Name, string InOriginFileName, int InReconcCycleNo)
        {
          ...
          + " ( "
            ...
            + " AND A.MatchingCateg <> 'BDC177'  "  // EXCLUDE BDC177
            + " AND B.MatchingCateg <> 'BDC177'  "  // EXCLUDE 
            + " ) "
            //+ " OR "
          ...
          + " AND A.RRNumber = B.RRNumber "
          + " AND A.Minutes_Date = B.Minutes_Date "
          + " AND A.TraceNo = B.TraceNo " // Include it for BDC177
                                          // + " AND A.TransAmt = B.TransAmt "
          + " WHERE "
          + " ( "
            + " (A.Processed = 0 AND LEFT(A.FullTraceNo, 1) = '4' ) " // Leave it as it is    
       ...
       + " WHERE(A.Processed = 0 AND LEFT(A.FullTraceNo, 1) = '4') "
                                           ...
                                           , int InReconcCycleNo)
        {
            ...
            SQLCmd =
                ...
                + " ,'" + PRX + "237'"  // UPDATE AS OTHER THEN BASED ON CARD WE SET UP BDC201
                                        //  + " ,case" // Destination
                                        //+ " WHEN LEFT([PAN_MASK],6) = '526402' THEN 'BDC200' "
                                        //+ " else 'BDC202' "
                                        //+ " end "
                 ...
                 //    + ",case "
                 // + " when [COD_TXN_MNEMONIC] = '2201'  THEN '" + PRX + "200'"  // From our ATMs 
                 // + " when [COD_TXN_MNEMONIC] = '2301'  THEN '" + PRX + "210'"  //  from 123 and others
                 // + " when [COD_TXN_MNEMONIC] = '2250' THEN '" + PRX + "200'" // deposits
                 // + " when [COD_TXN_MNEMONIC] = '2204' THEN '" + PRX + "200'" // transfer
                ...
                + " ,ISNULL(TRY_CAST([REF_SYS_TR_AUD_NO] AS INT),0)" // In place of trace 
                 ...
                 + "end "                                                                            //   
                                                                                                     //  + ", ISNULL([PAN_MASK], '') "  // 
                + " , RIGHT(COD_ACCT_NO, 16) "     // Account Number                                                                        //+ " , ISNULL([COD_ACCT_NO], '') "
         ...
         + " AND t1.Net_TransDate = t2.Net_TransDate "
          ...
          ;  // 
            ...
            // 
            // Reason is because COREBANKING has wrong terminal whereas 123 and IST is correct
        ...
        + ",CAP_DATE = t2.CAP_DATE "
          ...
          + " WHERE  (t1.Processed = 0 and t1.AmtFileBToFileC = 0 )  "
            ...
            // ***************************
            SQLCmd = "  UPDATE[RRDM_Reconciliation_ITMX].[dbo].[COREBANKING] "
                    + " SET [TransTypeAtOrigin] = 'INTERNAL' "
                    + " WHERE Processed = 0 AND MatchingCateg = '" + PRX + "131'  "
                    ;
        ...
        + " ON "
         ...
         + " WHERE t1.Processed = 0  AND t1.AccNo <> t2.AccNo AND t1.MatchingCateg = '" + PRX + "101'"
         + " AND ( t2.Processed = 0 AND t2.MatchingCateg = '" + PRX + "101')";
        ...
        //// CREATE COREBANKING FROM CORE
        /////
        public void InsertRecords_GTL_COREBANKING_3(string InOriginFileName, string InFullPath
                                           , int InReconcCycleNo)
        {
            ...
            if (MessageBox.Show("Do you want to use Flexcube file that will be converted to COREBANKING File?" + Environment.NewLine
                              , "Verification Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                       == DialogResult.Yes)
            {
                // YES ConvertFile

                MessageBox.Show("This is a temporary RRDM Version." + Environment.NewLine
                             + "It converts Flexcube File into Expected T24 COREBANKING File." + Environment.NewLine
                             + "When the COREBANKING file will be available this code will be deleted." + Environment.NewLine
                             + "The purpose of it is to enable us to do testing " + Environment.NewLine
                               + "for all changes on set up code and data bases for the introduction of T24." + Environment.NewLine
                             );
            ...
            {
                // DO not convert file 
                MessageBox.Show("The actual file that it is in COREBANKING Directory will be used." + Environment.NewLine
                            + " No convertion from Flexcube File into Expected T24 COREBANKING File will be made.");
            ...
            if (ConvertFile == true)
            {
                ...
                SQLCmd = " Update [RRDM_Reconciliation_ITMX].[dbo].BULK_" + InOriginFileName
                         + " SET COD_CC_BRN = '1' "
                         + " WHERE COD_CC_BRN = '15'  AND[ACQ_INST_ID] = '601520' "

                         + " Update [RRDM_Reconciliation_ITMX].[dbo].BULK_" + InOriginFileName
                         + " SET[COD_GL_ACCT] =  'EGP1' + TERM_ID +  RIGHT('0000' + COD_CC_BRN, 4) "
                         + " WHERE[ACQ_INST_ID] = '601520' "
                        + " ";
            ...
            SQLCmd =
                ...
                + " when [COD_TXN_MNEMONIC] = '2208'  THEN 11 " // Fawry
                  ...
                  // + ",[CA_NAME] " //  in place of Transction Description 
                  + ",case "
                + " when [COD_TXN_MNEMONIC] = '9001'  THEN 'From OWN ATMS - Withdrawl'  " // From our ATMs 
                + " when [COD_TXN_MNEMONIC] = '2301'  THEN 'From 123 and others - Debit'  " //  from 123 and others
                + " when [COD_TXN_MNEMONIC] = '895' THEN 'From OWN ATMS - Deposits' " // deposits
                + " when [COD_TXN_MNEMONIC] = '9004' THEN 'POS' " // POS
                + " when [COD_TXN_MNEMONIC] = '774'  THEN 'Fawry' " // Fawry
                  + " else 'Not Found' "
                  + "end "
                  + ", '818' "
                 + ",CAST([AMT_TXN_LCY] As decimal(18,2)) "
                ...
                + ",RIGHT('000000000000'+ISNULL(rtrim(RETRIEVAL_REF_NO),''),12)" // in place RRN 12 digit 
                 ...
                 + "end "                                                                            //   
                                                                                                     //  + ", ISNULL([PAN_MASK], '') "  // 
               // + " , RIGHT(COD_ACCT_NO, 16) "
                 + ",RIGHT('0000000000000000'+ISNULL(rtrim(COD_ACCT_NO),''),16)"
                + ", '0' " // In Place of PCODE
                 + ", @LoadedAtRMCycle"
                  + ", @Operator"
         ...
         + " ,EXTERNAL_DATE = t2.EXTERNAL_DATE "
          ...
          + " ON "
          // + " t1.Processed = t2.Processed "
          + "  t1.TerminalId = t2.TerminalId" //terminal not the same for Meeza
          //+ " AND t1.TransDate = t2.TransDate "
          + " AND t1.TraceNo = t2.TraceNo " // OFF FOR T24
          + " AND t1.TransAmt = t2.TransAmt "
          + " AND t1.AccNo = t2.AccNo "
          + " WHERE  (t1.Processed = 0 ) "
            + "AND ((t2.Processed = 0 AND T2.TXNDEST = '1')  "
            + " OR (t2.Processed = 0 AND T2.TXNDEST = '12')  "
            //  + "      OR (t2.Processed = 1 AND T2.TXNDEST = '1' AND t2.Comment = 'Reversals' AND t2.Net_TransDate>@Net_Minus )) "
            + "      OR (T2.TXNDEST = '1' AND t2.Comment = 'Reversals' AND t2.Net_TransDate>@Net_Minus )) "
          ;  // 
            ...
            //
            // UPDATE details from IST where Origin Meeza or ATMs 
            // BASED ON RRN and Amnt etc 
            // 
            // Reason is because COREBANKING has wrong terminal whereas 123 and IST is correct
            // Terminal not included in matching 
          ...
          + " WHERE  "
          + "  (t1.Processed = 0 and t1.AmtFileBToFileC = 0 )  AND ((t2.Processed = 0 AND (T2.TXNSRC = '8' OR T2.TXNSRC = '18' OR T2.TXNSRC = '1') AND T2.TXNDEST = '1')  "
           //  + "      OR (t2.Processed = 1 AND (T2.TXNSRC = '8' OR T2.TXNSRC = '18') and T2.TXNDEST = '1' AND t2.Comment = 'Reversals' AND t2.Net_TransDate>@Net_Minus )) "
           + "      OR ((T2.TXNSRC = '8' OR T2.TXNSRC = '18') and T2.TXNDEST = '1' AND t2.Comment = 'Reversals' AND t2.Net_TransDate>@Net_Minus )) "
           ; // 123  
        ...
        + ",CAP_DATE = t2.CAP_DATE "
          ...
          + " WHERE  t1.Processed = 0  and t1.AmtFileBToFileC = 0  "
            ...
            //
            // UPDATE Transaction amount where it is different in COREBANKING from IST 
          ...
          + " WHERE  t1.Processed = 0 AND t2.Processed = 0 and t1.AmtFileBToFileC = 0 "
                    + "AND t2.MatchingCateg = 'BDC177' AND t1.TransAmt <> t2.TransAmt "
       ...
       ;
                                           ...
                                           , int InReconcCycleNo)
        {
            ...
            SQLCmd = "INSERT INTO [RRDM_Reconciliation_ITMX].[dbo].[MEEZA_OTHER_ATMS]  "
                 ...
                 + " ,'" + PRX + "170' " // Meeza OTHER ATMs - It can be BDC270(Debit) or BDC271(Prepaid) 
          ...
          + " WHERE  "
          + "(t1.Processed = 0  AND t1.MatchingCateg in ('" + PRX + "170', '" + PRX + "271')) " // in previous we have set all bdc270
          + " AND (t2.Processed = 0 OR (t2.Processed=1 AND t2.Comment = 'Reversals' AND t2.Net_TransDate>@Net_Minus  ) ) "
          + "AND  t2.MatchingCateg in ('" + PRX + "170', '" + PRX + "271')"
          ; // For not processed yet records
       ...
       ;
                                           ...
                                           , int InReconcCycleNo)
        {
          ...
          ; // For not processed yet records
            ...
            // DATE 2024-11-27 Dina Said That all with 548446 is TELDA and do not exist in IST and COREBANKING
            // 54844608
            ...
            //// They are not in COREBANKING .... So we insert them not to show unmatched 
            //// INSERT NEW RECORDS IN COREBANKING
            //// THESE ARE RECORDS COMING FROM BIN 
            //// 54844608****4316 
            //// WE have set it in Category BDC277


            SQLCmd = "INSERT INTO [RRDM_Reconciliation_ITMX].[dbo].[COREBANKING]"
                + "( "
                 + " [OriginFileName] "
                 + " ,[Origin] "
                  + " ,[MatchingCateg] "
                 ...
                 + " FROM [RRDM_Reconciliation_ITMX].[dbo].[MEEZA_GLOBAL_LCL] "  // FROM 
                  ...
                  + " WHERE  left(CardNumber, 6) in ( '548446', '440701','510493'"
                                                    + ",'520031', '553592' )" // TESLA AND OTHERS 
                                                                              //+ " AND [Comment] = '54844608 Marked as gone to COREBANKING' "
       ...
       ;
                                           ...
                                           , int InReconcCycleNo)
        {
            ...
            SQLCmd = "INSERT INTO [RRDM_Reconciliation_ITMX].[dbo].[MEEZA_POS]  "
                 ...
                 + " ,@Origin"
                  ...
                  + " ,CASE " // LEAVE IT 
                 + " WHEN Left(PAN, 8 )= '50780309' THEN '" + PRX + "272' "  // Goes to COREBANKING
                ...
                + " WHEN Left(PAN, 6 )= '507808' THEN Left(PAN, 6 )+ '**' + '****' + right([PAN], 4) " // 
                 ...
                 + ",'8' "   // Origin Meeza
                  + " ,CASE " // LEAVE IT 
                 + " WHEN Left(PAN, 8 )= '50780309' THEN '1' "  // Goes to COREBANKING
        ...
        + "(t2.Processed = 0 OR (t2.Processed=1 AND t2.Comment = 'Reversals' ) )"
          ...
          ; // For not processed yet records
            ...
            // OR  BDC272 .... for IST AND COREBANKING
...
+ " ORDER BY ATMId, TransactionSequence, CurrencyCode ";
                                           ...
                                           , int InReconcCycleNo)
        {
            ...
            SQLCmd =
                ...
                + "( "
                 ...
                 + " WHEN ACQISS = 'I' AND ( LEFT([PAN],6) = '526402' OR LEFT([PAN],6) = '544460' OR LEFT([PAN],6) = '557876' ) THEN '" + PRX + "130' " // All DEBIT
            ...
            SQLCmd =
                ...
                + "( "
                 ...
                 + " ,@Origin"  // 2.1
                  + " ,'EXTERNAL' "  // 2.2
                   + " ,case" // Destination // 3 
                 + " WHEN ( LEFT([PAN_MASK],6) = '526402' OR LEFT([PAN_MASK],6) = '544460' OR LEFT([PAN_MASK],6) = '557876') THEN '" + PRX + "131' " // All DEBIT
            ...
            if (InMode == 1)
            {
             ...
             " UPDATE [RRDM_Reconciliation_ITMX].[dbo].[Master_Card] "
              ...
              + " AND t1.TransAmt = t2.TransAmt"
                ...
                + " WHERE  (t1.Processed = 0) "
                + " AND ((t2.Processed=0 AND T2.MatchingCateg in ('" + PRX + "130','" + PRX + "232')) "
                       + "OR (t2.Processed=1 AND T2.MatchingCateg in ('" + PRX + "130','" + PRX + "232') AND t2.Comment = 'Secret Accounts' AND t2.Net_TransDate>= @Net_TransDate) "
                           + " OR (t2.Processed = 1 AND T2.MatchingCateg in ('" + PRX + "130','" + PRX + "232') AND t2.Comment = 'Reversals' AND t2.Net_TransDate>= @Net_TransDate )) "
                ;
             ...
             " UPDATE [RRDM_Reconciliation_ITMX].[dbo].[FAWRY]"
              ...
              + " WHERE  (t1.Processed = 0 ) "
                   + "AND ((t2.Processed = 0 and T2.MatchingCateg = '" + PRX + "131' )  "
                     + " OR (t2.Processed = 1 and T2.MatchingCateg = '" + PRX + "131' AND t2.Comment = 'Secret Accounts' AND t2.Net_TransDate>= @Net_TransDate ) "
                           + " OR (t2.Processed = 1 AND t2.MatchingCateg = '" + PRX + "131' AND t2.Comment = 'Reversals' AND t2.Net_TransDate>= @Net_TransDate )) "
                ;
    ...
    + " WHERE  (t1.IsMatchingDone = 0 AND t1.Origin='Our Atms' AND t1.MatchingCateg <> 'BDC209' ) "
     + "AND ("
            ...
            SQLCmd = "  UPDATE[RRDM_Reconciliation_ITMX].[dbo].[tblMatchingTxnsMasterPoolATMs] "
                     + " SET AccNumber = RIGHT(ltrim(rtrim(AccNumber)),16) "
    ...
    + " WHERE  (t1.IsMatchingDone = 0  AND t1.Origin='Our Atms' ) "; // For not processed yet records
            ...
            Acc.ReadAllATMsAndUpdateAccNo_T24(WOperator);
        ...
        public void UpdateMasterAfterMatchingWithSecondCurrency(string InOperator, int InReconcCycleNo)
        {
            ...
            try
            {
                ...
                string SQLCmd = "DELETE FROM [RRDM_Reconciliation_ITMX].[dbo].[Switch_IST_Txns_TWO_Currencies] "
                    + "  WHERE MatchingCateg NOT IN('BDC130', 'BDC232' , 'BDC235', 'BDC236' , 'BDC225')   "
                    + " "
                    ;
        ...
        "                             ('BDC130', 'BDC232', 'BDC235' , 'BDC236' , 'BDC225') "
      ...
      "                             ('BDC225') "
        ...
        public void DeleteRecordsToSetStartingPoint(string InOperator, DateTime InDate, DateTime InCut_Off_Date, int InRMCycleNo, int InMode)
        {
            ...
            // DELETE FROM COREBANKING THE UNWANTED
            // CATEGORY 231 is not ACTIVE YET
            ...
            using (SqlConnection conn = new SqlConnection(recconConnString))
                ...
                catch (Exception ex)
                {
                    ...
                    CatchDetails_2(ex, "Origin:Meeza POS 0898");
                }
            ...
            using (SqlConnection conn = new SqlConnection(recconConnString))
                ...
                catch (Exception ex)
                {
                    ...
                    CatchDetails_2(ex, "Origin:Master POS 0998");
                }
...
+ "  WHERE MatchingCateg = '" + PRX + "279'  "
            ...
            //    DelCount = 0;
            //    SQLCmd = "DELETE FROM [RRDM_Reconciliation_ITMX].[dbo].[Switch_IST_Txns] "
            //       + " WHERE TransDate  < @TransDate AND MatchingCateg in ('BDC230','BDC231','BDC232','BDC233','BDC235','BDC236')  "
            //       + " "
            //       ;
            ...
            //if (Gp.RecordFound == true & MeezaIsPresent == true) // 
            //{
            //    DelCount = 0;
            //    SQLCmd = "DELETE FROM [RRDM_Reconciliation_ITMX].[dbo].[Switch_IST_Txns] "
            //       + " WHERE TransDate  < @TransDate AND MatchingCateg in ('BDC277','BDC278')  "
            //       + " "
            //       ;
            ...
            //            CatchDetails_2(ex, "Origin:Meeza01");
            //        }
