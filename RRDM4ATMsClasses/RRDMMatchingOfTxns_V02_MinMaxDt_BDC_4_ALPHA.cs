...
namespace RRDM4ATMs
{
    public class RRDMMatchingOfTxns_V02_MinMaxDt_BDC_4_ALPHA : Logger
    {
        public RRDMMatchingOfTxns_V02_MinMaxDt_BDC_4_ALPHA() : base() { }
        /// <summary>
           ...
           // RRDMAtmsMinMax Mm = new RRDMAtmsMinMax();
            ...
            if (FromOwnATMs == true)
            {
                ...
                while (I <= (TableThisGroupAtms.Rows.Count - 1))
                {
                    ...
                    //AtmNo = '00015999'
                    if (WAtmNo == "95101028" & InMatchingCateg == "EMR306")
                    {
                        // testing
                        WAtmNo = WAtmNo;
                    }
                        ...
                        if (NumberOfTables == 3)
                        {
                            ...
                            {
                                // CASE WHERE EMR306 (Foreign) not Loaded
                                I++; // Read Next entry of the table 
                                continue;
                            }
                        ...
                        MinMaxDt_01 = NullPastDate;
                        MinMaxDt_02 = NullPastDate;
                        MinMaxDt_03 = NullPastDate;
                        DateTime MinMaxDtTwoTables = NullPastDate;
                        DateTime MinMaxDtThreeTables = NullPastDate;
                        ...
                        // Two Tables
                            ...
                            MinMaxDtTwoTables = array1.Where(a => a != NullPastDate).Min();
                        ...
                        if (NumberOfTables == 3)
                        {
                            // Three Tables
                                ...
                                MinMaxDtThreeTables = array1.Where(a => a != NullPastDate).Min();
                                //
                    ...
                    if (NumberOfTables == 2)
                    {
                            ...
                            // ALL EQUAL to MINMax
                            MinMaxDt_01 = MinMaxDtTwoTables;
                            MinMaxDt_02 = MinMaxDtTwoTables;
                    ...
                    if (NumberOfTables == 3)
                    {
                            ...
                            MinMaxDt_01 = MinMaxDtThreeTables;
                            MinMaxDt_02 = MinMaxDtThreeTables;
                            MinMaxDt_03 = MinMaxDtThreeTables;
