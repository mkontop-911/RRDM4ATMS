...
namespace RRDMJournalsTransfer
{
    public class RRDMJournalsTransferClass
    {
        ...
        public JournalType TypeOfJournal { get; set; }
        ...
        public void JournalProcessing()
        {
            ...
            switch (this.TypeOfJournal)
            {
                case JournalType.DBL:
                    ProcessDbl();
                    break;
                case JournalType.NCR:
                    ProcessNcr();
                    break;
                case JournalType.NCR_VISION:
                    ProcessNcrVision();
                    break;
                case JournalType.OTHER:
                    ProcessOth();
                    break;
                case JournalType.WCR:
                    ProcessWcr();
                    break;
                default:
                    break;
