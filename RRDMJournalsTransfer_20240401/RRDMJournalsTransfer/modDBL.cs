    ...
    public static void ProcessDblDirectory()
    {
        ...
        try
        {
            ...
            if (System.IO.Directory.Exists(sPath + @"\"))
            {
                ...
                {
                    if (RRDM4ATMs.PublicFn.DeleteFiles(sTargetDirectory))
                    {
                ...
                if (oMatch.Success)
                {
                    try
                    {
                        ...
                        if (resultFile.Extension == sOldExtension)
                        {
                            ...
                            {
                                sDestination = "";
                                sDestination = sTargetDirectory + @"\" + RRDM4ATMs.PublicFn.fnRight(("00000000" + sAtmName) , 8) + "_" + fileNameDateTime + "_EJ_DBL.00" + resultFile.Name.Substring(10, 1);
