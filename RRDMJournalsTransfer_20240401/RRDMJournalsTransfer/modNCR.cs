                    ...
                    if (oMatch.Success)
                    {
                        ...
                        if (resultFile.Extension == sOldExtension)
                        {
                               ...
                               (Int64.Parse(dtCreationDate.ToString("yyyyMMdd")) <= Int64.Parse(dtToDate.ToString("yyyyMMdd"))))
                            {
                                ...
                                sDestination = sTargetDirectory + @"\" + RRDM4ATMs.PublicFn.fnRight(("00000000" + sAtmLevel), 8) + "_" + sYearLevel + resultFile.Name.Substring(0, 4) + "_EJ_NCR." + iExtensionCounter.ToString("000");
